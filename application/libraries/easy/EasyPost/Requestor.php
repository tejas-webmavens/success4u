...
class Requestor
{
    ...
    private function _requestRaw($method, $url, $params)
    {
        ...
        // echo "methods:<br/><pre>".print_r($method)."</pre>";
        // echo "absUrl:<br/><pre>".print_r($absUrl)."</pre>";
        // echo "headers:<br/><pre>".print_r($headers)."</pre>";
        // echo "params:<br/><pre>".print_r($params)."</pre>";
        // echo "myApiKey:<br/><pre>".print_r($myApiKey)."</pre>";exit;
