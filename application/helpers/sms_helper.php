<?php
  ...
  */
  function sendbulksms($pno,$message)
  {

    $CI =& get_instance();
    $CI->load->model('admin/Sms_model');

    $sms_data = array();
    $smsdetails = $CI->Sms_model->Getdatas();
    ...
    $smsstatus = $sms_data['smsstatus'];
    $smsauthurl = $sms_data['smsauthurl'];
    $senderno = $sms_data['senderno'];

    $username = $sms_data['smsauthuser'];
    $password = $sms_data['smsauthpassword'];
    ...
    */
    ...
    $post_body = unicode_sms( $username, $password, $message, $pno);
    $result='';
