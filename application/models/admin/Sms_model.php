...
class Sms_model extends CI_Model {
	...
	public function Checksms($condition='') {
		...
		if($condition)
			$condition="Page='smssetting' AND KeyValue='".$condition."'";
	...
	public function Update($data) {
		...
		$this->db->query("DELETE FROM arm_setting WHERE Page='smssetting'");
	...
	public function Getdatas($KeyValue='') {
