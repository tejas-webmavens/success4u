...
class Recurringsetting_model extends CI_Model {

	public function Update($data) {
		//print_r($data);
		
		$this->db->query("DELETE FROM arm_setting WHERE Page='recurringsetting'");
	...
	public function Getdata($KeyValue='') {
		...
		$condition = "Page =" . "'recurringsetting'";
