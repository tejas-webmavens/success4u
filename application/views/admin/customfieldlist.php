                ...
                <div class="col-md-12">
                    <div class="panel panel-visible" id="spy6">
                        <div class="panel-heading">
                            ...
                            <div class="panel-title hidden-xs">
                                <?php echo ucwords($this->lang->line('pagetitle_customlist'));?>
                                <span class="allcp-form"><a class="btn btn-primary pull-right" title="" data-toggle="tooltip" href="<?php echo base_url();?>admin/customfieldsetting/addfield" data-original-title="Add New"><i class="fa fa-plus"></i></a></span>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th class="va-m"><?php echo $this->lang->line('label_customfieldlabel');?></th>
                                        <th class="va-m"><?php echo $this->lang->line('label_customfieldname');?></th>
                                        <th class="va-m"><?php echo $this->lang->line('label_customfieldtype');?></th>
                                        <th class="va-m"><?php echo $this->lang->line('label_customfieldsize');?></th>
                                        <th class="va-m"><?php echo $this->lang->line('label_customfieldpage');?></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php
                                        ...
                                        if($this->data['cusomfield']) {
                                            $i=0;
                                            foreach ($this->data['cusomfield']  as $row) {
                                                $i++;
                                    ?>
                                    <tr>
                                        ...
                                        <td class=""><?php echo $row->CustomLabel;?></td>
                                        <td class=""><?php echo $row->CustomName;?></td>
                                        <td class=""><?php echo $row->CustomType;?></td>
                                        <td class=""><?php echo $row->CustomValue;?></td>
