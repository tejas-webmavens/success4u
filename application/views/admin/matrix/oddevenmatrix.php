...
<div class="section row mb10">
    ...
    <div class="section row mb10">
        <label for="xupcount"
        class="field-label col-sm-3 ph10 text-left"> <?php echo  ucwords($this->lang->line('oddevenposition')); ?><sup><em class="state-error"><?php echo  ucwords($this->lang->line('star')); ?></em></sup></label>

        <div class="col-sm-5 ph10">
            <label for="xupcount" class="field prepend-icon">
                <input type="text" name="position" id="position"
                class="gui-input"  placeholder="<?php echo  ucwords($this->lang->line('oddcount')); ?>"
                value="<?php echo set_value('xupcount', isset($matrixdetails->Position) ? $matrixdetails->Position : '');?>">
                <label for="xupcount" class="field-icon">
