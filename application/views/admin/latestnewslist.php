                ...
                <div class="col-md-12">
                    <div class="panel panel-visible" id="spy6">
                        <div class="panel-heading">
                            ...
                            <div class="row">
                            <div class="col-md-4">
                                <?php echo ucwords($this->lang->line('pagetitle_latestnews'));?>
                                </div>
                                <div class="col-md-1 pull-right">
                                <span class="allcp-form"><a class="btn btn-primary pull-right" title="" data-toggle="tooltip" href="<?php echo base_url();?>admin/latestnews/updatelatestnews" data-original-title=" <?php echo ucwords($this->lang->line('pagetitle_addlatestnews'));?>"><i class="fa fa-plus"></i></a></span>
                               </div>
                               <div class="allcp-form col-md-4 pull-right">
                                        <form name="selectLanguage" method="post" id="selectLanguage" action="<?php echo base_url();?>admin/Latestnews/filter">
                                        <label for="languagename" class="field select">
                                            ...
                                            <select onChange="SelectedLanguageFunc(this.value)" name="languagename">
                                                <option value="" selected="selected"><?php echo ucwords($this->lang->line('news_language_Select'));?></option>
                                                <?php 
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th class="va-m"><?php echo $this->lang->line('label_header');?></th>
                                         <th class="va-m"><?php echo $this->lang->line('label_desp');?></th>
                                         <th class="va-m"><?php echo $this->lang->line('news_language_lbl'); ?></th>
                                    ...
                                    <tr>
                                       <!--  <td class="text-center">
                                        ...
                                        <td class=""><?php echo $row->NewsHeader;?></td>
                                        <td class=""><?php echo substr(urldecode($row->NewsDescription), 0, 30)?></td>
                                        <td class=""><?php echo ucfirst($content_language);?></td>
                                        <td class="allcp-form">
                                            <label class="block mt15 switch switch-primary">
                                                <input type="checkbox" <?php if($row->Status=='1') echo 'checked'; ?> id="t<?php echo $row->NewsId;?>" name="enablestatus" class="enablestatus" value="<?php echo $row->NewsId;?>">
                                                <label data-off="OFF" data-on="ON" for="t<?php echo $row->NewsId;?>"></label>
                                        ...
                                        <td class="">
                                            ...
                                            <div class="btn-group text-right">
                                                ...
                                                <ul role="menu" class="dropdown-menu">
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/latestnews/updatelatestnews/'.$row->NewsId;?>"><?php echo ucwords($this->lang->line('edit'));?></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/latestnews/delete/'.$row->NewsId;?>"><?php echo ucwords($this->lang->line('delete'));?></a>
                                                    </li>
