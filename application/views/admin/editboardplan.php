...
<div class="chute chute-center">
    ...
    <div class="mw1000 center-block">
        ...
        <div class="panel mb35">
            <form method="post" action="" id="allcp-form" enctype="multipart/form-data">
                <div class="panel-heading">
                    <span class="panel-title"><?php echo  ucwords($this->lang->line('pagetitle_bplanedit')); ?></span>
                    <span class="allcp-form"><a class="btn btn-primary pull-right" title="" data-toggle="tooltip" href="<?php echo base_url();?>admin/boardplansetting" data-original-title="Back"><i class="fa fa-close"></i></a></span>
                ...
                <div class="panel-body br-t">
                    ...
                    <div class="allcp-form theme-primary">
                        ...
                        <div class="section row mb10">
                            <label for="boardwidth" class="field-label col-sm-3 ph10  text-left"><?php echo  ucwords($this->lang->line('boardwidth')); ?><sup><em class="state-error"><?php echo  ucwords($this->lang->line('star')); ?></em></sup></label>

                            <div class="col-sm-7 ph10">
                                <label for="boardwidth" class="field prepend-icon">
                                    <input type="text" name="boardwidth" id="boardwidth" placeholder="<?php echo  ucwords($this->lang->line('boardwidth')); ?>"
                                    class="gui-input" value="<?php echo set_value('boardwidth', isset($this->data['fielddata']->BoardWidth) ? $this->data['fielddata']->BoardWidth : '');?>" >
                                    <label for="boardwidth" class="field-icon">
                                        <i class="fa fa-money"></i>
                                    </label>
                                </label>
                                <?php echo form_error('boardwidth');?>
                            </div>
                        </div>

                        <div class="section row mb10">
                            <label for="boarddepth" class="field-label col-sm-3 ph10  text-left"><?php echo  ucwords($this->lang->line('boarddepth')); ?><sup><em class="state-error"><?php echo  ucwords($this->lang->line('star')); ?></em></sup></label>

                            <div class="col-sm-7 ph10">
                                <label for="boarddepth" class="field prepend-icon">
                                    <input type="text" name="boarddepth" id="boarddepth" placeholder="<?php echo  ucwords($this->lang->line('boarddepth')); ?>"
                                    class="gui-input" value="<?php echo set_value('boarddepth', isset($this->data['fielddata']->BoardDepth) ? $this->data['fielddata']->BoardDepth : '');?>" >
                                    <label for="boarddepth" class="field-icon">
                                        <i class="fa fa-money"></i>
                                    </label>
                                </label>
                                <?php echo form_error('boarddepth');?>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-5 ph10">
                               ...
                               <div class="option-group field">
                                <label class="col-md-4 block mt15 option option-primary">
                                    ...
                                    <input type="radio" value='1' <?php if(1 == $this->data['fielddata']->Status) {echo "checked='checked'";} ?> name="status">
                                    <span class="radio"></span>
                                    <?php echo  ucwords($this->lang->line('enable'))?>
                                </label>

                                <label class="col-md-4 block mt15 option option-primary">
                                    <input type="radio" value='0' <?php if(0 == $this->data['fielddata']->Status) {echo "checked='checked'";} ?> name="status">
                                    <span class="radio"></span>
                     ...
                     <div class="section row mb10">
                            <label for="followsponsor"
                            class="field-label col-sm-3 ph10 text-left"><?php echo  ucwords($this->lang->line('followsponsor')); ?><sup><em class="state-error"><?php echo  ucwords($this->lang->line('star')); ?></em></sup></label>
                            ...
                            <div class="col-sm-5 ph10">
                               ...
                               <div class="option-group field">
                                <label class="col-md-4 block mt15 option option-primary">
                                    ...
                                    <input type="radio" value='1' <?php if(1 == $this->data['fielddata']->FollowSponsor) {echo "checked='checked'";} ?> name="followsponsor">
                                    <span class="radio"></span>
                                    <?php echo  ucwords($this->lang->line('enable'))?>
                                </label>

                                <label class="col-md-4 block mt15 option option-primary">
                                    <input type="radio" value='0' <?php if(0 == $this->data['fielddata']->FollowSponsor) {echo "checked='checked'";} ?> name="followsponsor">
                                    <span class="radio"></span>
                                    <?php echo  ucwords($this->lang->line('disable'))?>
                                </label>
                            </div>
                            <label for="followsponsor" class="field-icon">

                            </label>
                            <?php echo form_error('followsponsor');?>
                        </div>
                    </div>

                    <div class="section row mb10">
                            <label for="reentrystatus"
                            class="field-label col-sm-3 ph10 text-left"><?php echo  ucwords($this->lang->line('reentrysboardstatus')); ?><sup><em class="state-error"><?php echo  ucwords($this->lang->line('star')); ?></em></sup></label>
                            ...
                            <div class="col-sm-5 ph10">
                               ...
                               <div class="option-group field">
                                <label class="col-md-4 block mt15 option option-primary">
                                    ...
                                    <input type="radio" value='1' <?php if(1 == $this->data['fielddata']->ReentryBoardStatus) {echo "checked='checked'";} ?> name="reentrystatus">
                                    <span class="radio"></span>
                                    <?php echo  ucwords($this->lang->line('enable'))?>
                                </label>

                                <label class="col-md-4 block mt15 option option-primary">
                                    <input type="radio" value='0' <?php if(0 == $this->data['fielddata']->ReentryBoardStatus) {echo "checked='checked'";} ?> name="reentrystatus">
                                    <span class="radio"></span>
                                    <?php echo  ucwords($this->lang->line('disable'))?>
                                </label>
                            </div>
                            <label for="reentrystatus" class="field-icon">

                            </label>
                            <?php echo form_error('reentrystatus');?>
                        </div>
                    </div>

                    <div class="section row mb10">
                            <label for="reentrynextstatus"
                            class="field-label col-sm-3 ph10 text-left"><?php echo  ucwords($this->lang->line('reentrynboardstatus')); ?><sup><em class="state-error"><?php echo  ucwords($this->lang->line('star')); ?></em></sup></label>
                            ...
                            <div class="col-sm-5 ph10">
                               ...
                               <div class="option-group field">
                                <label class="col-md-4 block mt15 option option-primary">
                                    ...
                                    <input type="radio" value='1' <?php if(1 == $this->data['fielddata']->ReentryNextBoardStatus) {echo "checked='checked'";} ?> name="reentrynextstatus">
                                    <span class="radio"></span>
                                    <?php echo  ucwords($this->lang->line('enable'))?>
                                </label>

                                <label class="col-md-4 block mt15 option option-primary">
                                    <input type="radio" value='0' <?php if(0 == $this->data['fielddata']->ReentryNextBoardStatus) {echo "checked='checked'";} ?> name="reentrynextstatus">
                                    <span class="radio"></span>
                                    <?php echo  ucwords($this->lang->line('disable'))?>
                                </label>
                            </div>
                            <label for="reentrynextstatus" class="field-icon">

                            </label>
                            <?php echo form_error('reentrynextstatus');?>
                        </div>
                    </div>
        ...
        <div class="section row mb10">
            <label for="nextbaordplan" class="field-label col-sm-3 ph10 text-left"><?php echo  ucwords($this->lang->line('selectnextboard')); ?><sup><em class="state-error"><?php echo  ucwords($this->lang->line('star')); ?></em></sup></label>

            <div class="col-sm-7 ph10">
                <?php 
                
                ?>
                <label for="nextbaordplan" class="field select">
                    <select id="nextbaordplan" name="nextbaordplan">
                        <option value=""><?php echo  ucwords($this->lang->line('choosefield')); ?></option>
                        <?php 
                        for($i=0; $i<count($this->data['boarddetail']); $i++) {      ?>

                        <option <?php if($this->data['boarddetail'][$i]->PackageId == $this->data['fielddata']->ReentryNextBoard) {echo "selected";} ?> value="<?php echo $this->data['boarddetail'][$i]->PackageId;?>" ><?php echo  ucwords($this->data['boarddetail'][$i]->PackageName);?></option>
                ...
                <label for="nextbaordplan" class="field-icon">
                    <i class="fa "></i>
                </label>
                <?php echo form_error('nextbaordplan');?>
            </div>
        </div>
        ...
        <div class="section row mb10">
            <label for="boardcommission" class="field-label col-sm-3 ph10  text-left"><?php echo  ucwords($this->lang->line('boardcommission')); ?><sup><em class="state-error"><?php echo  ucwords($this->lang->line('star')); ?></em></sup></label>

            <div class="col-sm-7 ph10">
                <label for="boardcommission" class="field prepend-icon">
                    <input type="text" name="boardcommission" id="boardcommission" placeholder="<?php echo  ucwords($this->lang->line('boardcommission')); ?>"
                    class="gui-input" value="<?php echo set_value('boardcommission', isset($this->data['fielddata']->BoardCommission) ? $this->data['fielddata']->BoardCommission : '');?>" >
                    <label for="boardcommission" class="field-icon">
                        <i class="fa fa-money"></i>
                    </label>
                </label>
                <?php echo form_error('boardcommission');?>
            </div>
        </div>
        ...
        $lvlcomms =explode(",",$this->data['fielddata']->LevelCommission);
        ...
        <div class="section row mb10" id="upgradecommissiondivp">
            <label for="upgradecommission" class="field-label col-sm-4 ph10  text-left"><?php echo  ucwords($this->lang->line('upgradecommission')); ?><sup><em class="state-error"><?php echo  ucwords($this->lang->line('star')); ?></em></sup></label>
            <div class="col-sm-3 ph10">

                <input type='button' value='+' id='addupgradeButton'  class="btn btn-bordered btn-primary"  />
                <input type='button' value='-' id='removeupgradeButton' class="btn btn-bordered btn-primary" />
            </div>  
             <?php echo form_error('upgradecommission');?>
        </div>
        ...
        $upgradecomms =explode(",",$this->data['fielddata']->upgradelevel);


        for($i=0;$i<count($upgradecomms);$i++)
        {
            $upgrade=$i+1;
            ?>
            <div class="section row mb10" id="<?php echo"upgradecomms".$upgrade;?>">

                <label for="upgradecommission" class="field-label col-sm-3 ph10">
                              <?//echo ucwords($this->lang->line('level'));echo $lvl." ". ucwords($this->lang->line('comamount')); ?>

                    </label>
                    <div class="col-sm-7 ph10 mb10" id="<?php echo"upgradecommission".$lvl;?>">
                       <input type="text" name="upgradecommission[]" id="upgradecommission[]" placeholder="<?php echo  ucwords($this->lang->line('upgrade'));echo $lvl." ". ucwords($this->lang->line('comamount')); ?>"
                       class="gui-input" value="<?php echo $upgradecomms[$i];?>" >
                   </div></div>
                           ...
                           ?>
                           <div class="section row mb10" id="upgradecommissiondiv">
                     ...
                     <?php $plvlcomms =explode(",",$this->data['fielddata']->ProductLevelCommission);
...
$(document).ready(function(){
    ...
    $("#addupgradeButton").click(function () {
    ...
    var upgradecommissiondiv = $(document.createElement('div'))
         .attr("id", 'upgradecommission' + counter).attr("class", 'section row mb10');
 
    upgradecommissiondiv.after().html('<label class="col-sm-3 ph10 "></label><div class="col-sm-7 ph10 mb10"><input type="text" name="upgradecommission[]" placeholder="upgrade'+ counter+' Commission Amount" id="upgradecommission'+ counter+'" value="" class="gui-input" ></div>');
 
    upgradecommissiondiv.appendTo("#upgradecommissiondiv");
 
 
    counter++;
     });
 
     $("#removeupgradeButton").click(function () {
    if(counter==2){
          alert("No more textbox to remove");
          return false;
       }   
    ...
    counter--;
        ...
        $("#upgradecommission" + counter).remove();
    ...
    var msg = '';
    for(i=1; i<counter; i++){
      msg += "\n upgradecommissiondiv #" + i + $('#upgradecommissiondiv' + i).val();
    }
          alert(msg);
     });
  });
