...
<div class="chute chute-center">
    ...
    <div class="mw1000 center-block">
        ...
        <form method="post" action="<?php echo base_url(); ?>admin/banner/edit/<?php echo  $product->banner_id;?>" id="allcp-form" enctype="multipart/form-data">
                ...
                <div class="allcp-form theme-primary">
                    ...
                    <div class="section row mb10">
                        ...
                        <label class="col-md-3 block mt15 option option-primary">
                                    ...
                                    <input type="radio" <?php if(isset($product->status)==1){echo "checked='checked'";}else{echo "";}?> value='On' name="sitestatus">
                                    <span class="radio"></span>
                                        <?php echo  ucwords($this->lang->line('on'))?>
                                        </label>

                                    <label class="col-md-3 block mt15 option option-primary">
                                    <input type="radio" <?php if(isset($product->status)==0){echo "checked='checked'";}else{echo "";}?> value='Off' name="sitestatus">
                                    <span class="radio"></span>
                    ...
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                        <div class="fileupload-preview thumbnail mb20">
                            <img src="<?php if(isset($product->banner_image)){echo base_url().$product->banner_image; }?>" alt="holder">
                        </div>
