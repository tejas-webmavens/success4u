                    ...
                    <div class="panel panel-visible" id="spy6">
                        <div class="panel-heading">
                            ...
                            <div class="panel-title hidden-xs">
                                <?php echo ucwords($this->lang->line('pagetitle_testimonial'));?>
                                <span class="allcp-form"><a class="btn btn-primary pull-right" title="" data-toggle="tooltip" href="<?php echo base_url();?>admin/testimonial/addtestimonial" data-original-title="Add Testimonial"><i class="fa fa-plus"></i></a></span>
                                ...
                                <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th class="va-m"><?php echo $this->lang->line('label_username');?></th>
                                         <th class="va-m"><?php echo $this->lang->line('label_userlogo');?></th>
                                    ...
                                    <?php
                                        ...
                                        foreach ($testimonials['field']  as $row) {
                                             ...
                                             if($row->UserLogo)
                                             {
                                                $imagepath = base_url().'uploads/testimonial/'.$row->UserLogo;
                                             }
                                             else
                                             {
                                                if($row->ProfileImage)
                                                    $imagepath = base_url().'uploads/UserProfileImage/'.$row->ProfileImage;
                                                else 
                                                    $imagepath = base_url().'uploads/UserProfileImage/profile_avatar.jpg';
                                             }
                                    ?>
                                    <tr>
                                        <td class=""><?php echo $i;?></td>
                                        <td class=""><?php echo $row->UserName;?></td>
                                        <td class=""><img class="img-circle" alt="userlogo" data-src="holder.js/100%x140" src="<?php echo $imagepath; ?>" width="80px" height="80px"></td>
                                        ...
                                        <td class="">
                                            <div class="btn-group text-right">
                                                ...
                                                <ul role="menu" class="dropdown-menu">
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/testimonial/edittestimonial/'.$row->TestimonialId;?>"><?php echo ucwords($this->lang->line('edit'));?></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/testimonial/delete/'.$row->TestimonialId;?>"><?php echo ucwords($this->lang->line('delete'));?></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
