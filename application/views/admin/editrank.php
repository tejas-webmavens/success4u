                                ...
                                <div class="panel-body br-t">
                                    ...
                                    <div class="allcp-form theme-primary">
                                        ...
                                        <div class="section row mb10">
                                            <label for="downlinecount" class="field-label col-sm-3 ph10  text-left"><?php echo  ucwords($this->lang->line('downlinecount')); ?></label>

                                            <div class="col-sm-7 ph10">
                                                <label for="downlinemembercount" class="field prepend-icon">
                                                    <input type="text" name="downlinemembercount" id="rewardrank" placeholder="<?php echo  ucwords($this->lang->line('downlinemembercount')); ?>"
                                                    class="gui-input" value="<?php echo set_value('downlinemembercount', isset($this->data['fielddata']->Membercount) ? $this->data['fielddata']->Membercount : '');?>" >
                                                    <label for="downlinemembercount" class="field-icon">
                                        ...
                                        <div class="section row mb10">
                                            ...
                                            <div class="col-sm-7 ph10">
                                                <label for="referalcount" class="field prepend-icon">
                                                    <input type="text" name="referalcount" id="rewardpoint" placeholder="<?php echo  ucwords($this->lang->line('rewardpoint')); ?>"
                                                    class="gui-input" value="<?php echo set_value('referalcount', isset($this->data['fielddata']->ReferalCount) ? $this->data['fielddata']->ReferalCount : '');?>" >
                                                    <label for="referalcount" class="field-icon">
                                        ...
                                        <div class="section row mb10">
                                            <label for="balanceamount" class="field-label col-sm-3 ph10  text-left"><?php echo  ucwords($this->lang->line('balanceamount')); ?></label>

                                            <div class="col-sm-7 ph10">
                                                <label for="balanceamount" class="field prepend-icon">
                                                    <input type="text" name="targetbalance" id="reward" placeholder="<?php echo  ucwords($this->lang->line('reward')); ?>"
                                                    class="gui-input" value="<?php echo set_value('reward', isset($this->data['fielddata']->balanceAmount) ? $this->data['fielddata']->balanceAmount : '');?>" >
                                                    <label for="balanceamount" class="field-icon">
                                                        <i class="fa fa-money"></i>
                                                    </label>
                                                </label>
                                          ...
                                          <div class="section row mb10">
                                            ...
                                            <div class="col-sm-7 ph10">
                                                <label for="reward" class="field prepend-icon">
                                                    ...
                                                    class="gui-input" value="<?php echo set_value('reward', isset($this->data['fielddata']->Rank) ? $this->data['fielddata']->Rank : '');?>" >
