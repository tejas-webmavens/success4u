                    ...
                    <div class="panel panel-visible" id="spy6">
                        <div class="panel-heading">
                            ...
                            <div class="panel-title hidden-xs">
                                <?php echo ucwords($this->lang->line('pagetitle_autorespond'));?>
                                <span class="allcp-form"><a class="btn btn-primary pull-right" title="" data-toggle="tooltip" href="<?php echo base_url();?>admin/autorespond/addautorespond" data-original-title="Add Auto Respond"><i class="fa fa-plus"></i></a></span>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th class="va-m"><?php echo $this->lang->line('label_duration');?></th>
                                        <th class="va-m"><?php echo $this->lang->line('label_limitation');?></th>
                                    ...
                                    <?php
                                        $packages = $this->data;
                                        $i=0;
                                      if($packages['field'] != '') {  foreach ($packages['field']  as $row) {
                                             $i++;
                                    ?>
                                    <tr>
                                       <!--  <td class="text-center">
                                        ...
                                        <td class=""><?php echo $row->Limitation;?></td>
                                        <td class="allcp-form">
                                            <label class="block mt15 switch switch-primary">
                                                <input type="checkbox" <?php if($row->Status=='1') echo 'checked'; ?> id="t<?php echo $row->AutoRespondId;?>" name="enablestatus" class="enablestatus" value="<?php echo $row->AutoRespondId;?>">
                                                <label data-off="OFF" data-on="ON" for="t<?php echo $row->AutoRespondId;?>"></label>
                                        ...
                                        <td class="">
                                            ...
                                            <div class="btn-group text-right">
                                                ...
                                                <ul role="menu" class="dropdown-menu">
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/autorespond/editautorespond/'.$row->AutoRespondId;?>"><?php echo ucwords($this->lang->line('edit'));?></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/autorespond/delete/'.$row->AutoRespondId;?>"><?php echo ucwords($this->lang->line('delete'));?></a>
                                                    </li>
    ...
    $(document).ready(function() {
        ...
        $('.enablestatus').click(function() {
            if (!$(this).is(':checked')) {
                ...
                $.ajax({
                    type: 'post',
                    url:'<?php echo base_url();?>admin/autorespond/disable/'+id,
                    success : function()
                    {
                        console.log('sc');
                    }
                ...
                $.ajax({
                    type: 'post',
                    url:'<?php echo base_url();?>admin/autorespond/enable/'+id,
                    success : function(){
                        console.log('fail');
                    }
                });
