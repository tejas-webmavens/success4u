        ...
        <form method="post" action="" id="allcp-form" enctype="multipart/form-data">
            ...
            <div class="panel-body br-t">
                ...
                <h6 class="mb15"><?php echo  ucwords($this->lang->line('userlogo')); ?></h6>
                    ...
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                        <div class="fileupload-preview thumbnail mb20">
                            <img src="<?php echo base_url();?><?php echo  set_value('userlogo', isset($this->data['fielddata']->UserLogo) ? $this->data['fielddata']->UserLogo : '');?>" alt="holder">
                        </div>
                        <span class="btn btn-primary light btn-file btn-block ph10 mb10">
                            ...
                            <input type="file"  name="userlogo"  value="<?php echo set_value('userlogo', isset($this->data['fielddata']->UserLogo) ? $this->data['fielddata']->UserLogo : '');?>">
                        </span>
                    </div>
...
*/
                            for($i=0; $i<count($this->data['members']); $i++) {      ?>
                                 ...
                                 <option <?php if($this->data['members'][$i]->MemberId == $this->data['fielddata']->MemberId) {echo "selected";} ?> value="<?php echo $this->data['members'][$i]->MemberId;?>" ><?php echo  ucwords($this->data['members'][$i]->UserName);?></option>
                    ...
                    <div class="section row mb10">
                        ...
                        <div class="col-sm-9 ph10">
                            <label for="subject" class="field prepend-icon">
                                ...
                                class="gui-input" value="<?php echo set_value('subject', isset($this->data['fielddata']->Subject) ? $this->data['fielddata']->Subject : '');?>" >
                    ...
                    <div class="section row mb10">
                        ...
                        <div class="col-sm-9 ph10">
                            <label for="message" class="field prepend-icon">
                                ...
                                <textarea name="message" id="message" placeholder="<?php echo  ucwords($this->lang->line('message')); ?>" class="ckeditor gui-input" ><?php echo set_value('message', isset($this->data['fielddata']->Message) ? urldecode($this->data['fielddata']->Message) : '');?></textarea>
                     ...
                     <div class="section row mb10">
                        ...
                        <label for="status" class="field select">
                            ...
                            <option value=""><?php echo  ucwords($this->lang->line('choosefield')); ?></option>
                                 ...
                                 <option <?php if(0 == $this->data['fielddata']->Status) {echo "selected";} ?> value="0" ><?php echo  ucwords($this->lang->line('delete'));?></option>
                                 <option <?php if(1 == $this->data['fielddata']->Status) {echo "selected";} ?> value="1" ><?php echo  ucwords($this->lang->line('active'));?></option>
                                 <option <?php if(2 == $this->data['fielddata']->Status) {echo "selected";} ?> value="2" ><?php echo  ucwords($this->lang->line('publish'));?></option>
                                 <option <?php if(3 == $this->data['fielddata']->Status) {echo "selected";} ?> value="3" ><?php echo  ucwords($this->lang->line('unpublish'));?></option>
