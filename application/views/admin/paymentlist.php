                ...
                <div class="col-md-12">
                    <div class="panel panel-visible" id="spy6">
                        <div class="panel-heading">
                            ...
                            <div class="panel-title hidden-xs">
                                <?php echo ucwords($this->lang->line('pagetitle_paymentlist'));?>
                                <span class="allcp-form"><a class="btn btn-primary pull-right" title="" data-toggle="tooltip" href="<?php echo base_url();?>admin/" data-original-title="Back"><i class="fa fa-close"></i></a></span>
                                ...
                                <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                       <!--  <th>
                                        ...
                                        <th class="va-m"><?php echo $this->lang->line('label_logo');?></th>
                                        <th class="va-m"><?php echo $this->lang->line('label_position');?></th>
                                        <th class="va-m"><?php echo $this->lang->line('label_status');?></th>
                                        <th class="va-m"><?php echo $this->lang->line('label_mode');?></th>
                                    ...
                                    <?php
                                        $customers = $this->data;
                                        $i=0;
                                        foreach ($customers['paymentdetails']  as $row) {
                                    ...
                                    <tr>
                                        <!-- <td class="text-center">
                                            <label class="option block mn">
                                                <input type="checkbox" name="inputname[]" value="<?php echo $row->RequireId;?>" class="case">
                                                <span class="checkbox mn"></span>
                                            </label>
                                        </td> -->
                                        <td class=""><?php echo $i;?></td>
                                        <td class=""><?php echo $row->PaymentName;?></td>
                                        <td class=""><img alt="paymentlogo" src="../<?php echo $row->PaymentLogo; ?>" width="120px" height="50px"></td>
                                        
                                        <td class=""><?php echo $row->Position;?></td>
                                        
                                        <td class="allcp-form">
                                            <label class="block mt15 switch switch-primary">
                                                <input type="checkbox" <?php if($row->PaymentStatus=='1') echo 'checked'; ?> id="t<?php echo $row->PaymentId;?>" name="paymentstatus" class="paymentstatus" value="<?php echo $row->PaymentId;?>">
                                                <label data-off="OFF" data-on="ON" for="t<?php echo $row->PaymentId;?>"></label>
                                        ...
                                        <td class="allcp-form">
                                            <label class="block mt15 switch switch-primary">
                                                <input type="checkbox" <?php if($row->PaymentMode=='1') echo 'checked'; ?> id="tr<?php echo $row->PaymentId;?>" name="requirestatus" class="requirestatus" value="<?php echo $row->PaymentId;?>">
                                                <label data-off="Test" data-on="Live" for="tr<?php echo $row->PaymentId;?>"></label>
                                                <span><?php //echo $row->MemberStatus;?></span>
                                            </label>
                                        ...
                                        <td class="">
                                            ...
                                            <div class="btn-group text-right">
                                                ...
                                                <ul role="menu" class="dropdown-menu">
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/paymentsetting/editfield/'.$row->PaymentId;?>">Edit</a>
                                                    </li>
    ...
    $(document).ready(function() {
        ...
        $('.paymentstatus').click(function() {
            if (!$(this).is(':checked')) {
                ...
                $.ajax({
                    type: 'post',
                    url:'<?php echo base_url();?>admin/paymentsetting/disable/'+id,
                    success : function()
                    {
                        console.log('disable');
                    }
                ...
                $.ajax({
                    type: 'post',
                    url:'<?php echo base_url();?>admin/paymentsetting/enable/'+id,
                    success : function(){
                        console.log('enable');
                    }
                });
        ...
        $('.requirestatus').click(function() {
            if (!$(this).is(':checked')) {
                ...
                $.ajax({
                    type: 'post',
                    url:'<?php echo base_url();?>admin/paymentsetting/inactive/'+id,
                    success : function()
                    {
                        console.log('test');
                    }
                ...
                $.ajax({
                    type: 'post',
                    url:'<?php echo base_url();?>admin/paymentsetting/active/'+id,
                    success : function(){
                        console.log('live');
                    }
                });
