    ...
    <div class="mw1000 center-block">
        ...
        <form method="post" action="" id="allcp-form" enctype="multipart/form-data">
            <div class="panel-heading">
                <span class="panel-title"><?php echo  ucwords($this->lang->line('pagetitle_addepin')); ?></span>
...
*/                             if($this->data['packagedetail']!='')
                    ...
                    <div class="section row mb10">
                        ...
                        <div class="col-sm-7 ph10">
                            ...
                            <div class="gui-input" ></div>
                               <!--  <input type="text" name="amount" id="amountss" placeholder="<?php echo  ucwords($this->lang->line('amount')); ?>" class="gui-input" value="" />  -->
                    ...
                    <div class="section row mb10">
                        <label for="epincount" class="field-label col-sm-3 ph10  text-left"><?php echo  ucwords($this->lang->line('epincounts')); ?><i color"#e74c3c"><sup><em class="state-error"><?php echo  ucwords($this->lang->line('star')); ?></em></sup></i></label>

                        <div class="col-sm-7 ph10">
                            <label for="epincount" class="field prepend-icon">
                                <input type="text" onkeyup="settotal(this.value)" maxlength="2" name="epincount" id="epincount" placeholder="<?php echo  ucwords($this->lang->line('epincounts')); ?>"
                                class="gui-input" value="" >
                                <label for="epincount" class="field-icon">
                                    <i class="fa fa-info"></i>
                                </label>
                            </label>
                             <?php echo form_error('epincount');?>
                        </div>
                    </div>
                    ...
                    <div class="section row mb10">
                        <label for="expirydate" class="field-label col-sm-3 ph10  text-left"><?php echo  ucwords($this->lang->line('expiry')); ?><sup><em class="state-error"><?php echo  ucwords($this->lang->line('star')); ?></em></sup></label>

                        <div class="col-sm-7 ph10">
                           <label for="expirydate" class="field prepend-icon">
                                            <input readonly type="text" id="datepicker2" name="expirydate" class="gui-input fs13" placeholder="<?php echo  ucwords($this->lang->line('expiry')); ?>" value="<?php echo set_value('expirydate');?>">
