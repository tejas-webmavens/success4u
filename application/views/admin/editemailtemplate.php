    ...
    <div class="mw1000 center-block">
        ...
        <form method="post" action="" id="allcp-form" enctype="multipart/form-data">
            <div class="panel-heading">
                <span class="panel-title"><?php echo  ucwords($this->lang->line('pagetitle_editemailtemplate')); ?></span>
                <span class="allcp-form"><a class="btn btn-primary pull-right" title="" data-toggle="tooltip" href="<?php echo base_url();?>admin/emailtemplate" data-original-title="Back"><i class="fa fa-close"></i></a></span>
            ...
            <div class="panel-body br-t">
                ...
                <div class="allcp-form theme-primary">
                    <div class="section row mb10">
                        <label for="page" class="field-label col-sm-3 ph10  text-left"><?php echo  ucwords($this->lang->line('page')); ?><sup><em class="state-error"><?php echo  ucwords($this->lang->line('star')); ?></em></sup></label>

                        <div class="col-sm-7 ph10">
                           <label for="page" class="field prepend-icon">
                                            <input type="text" id="page" name="page" class="gui-input fs13" placeholder="<?php echo  ucwords($this->lang->line('page')); ?>" value="<?php echo  $this->data['fielddata']->Page;?>">
                    ...
                    <div class="section row mb10">
                        <label for="emailid" class="field-label col-sm-3 ph10  text-left"><?php echo  ucwords($this->lang->line('emailid')); ?><sup><em class="state-error"><?php echo  ucwords($this->lang->line('star')); ?></em></sup></label>

                        <div class="col-sm-7 ph10">
                            <label for="emailid" class="field prepend-icon">
                                <input type="text" name="emailid" id="emailid" placeholder="<?php echo  ucwords($this->lang->line('emailid')); ?>"
                                class="gui-input" value="<?php echo  $this->data['fielddata']->FromEmailId;?>" >
                    ...
                    <div class="section row mb10">
                        <label for="sender" class="field-label col-sm-3 ph10  text-left"><?php echo  ucwords($this->lang->line('sender')); ?><sup><em class="state-error"><?php echo  ucwords($this->lang->line('star')); ?></em></sup></label>

                        <div class="col-sm-7 ph10">
                           <label for="sender" class="field prepend-icon">
                                            <input type="text" id="sender" name="sender" class="gui-input fs13" placeholder="<?php echo  ucwords($this->lang->line('sender')); ?>" value="<?php echo  $this->data['fielddata']->FromName;?>">
                                            <label class="field-icon">
                                                <i class="fa fa-user"></i>
                                            </label>
                                        </label>
                    ...
                    <div class="section row mb10">
                        ...
                        <div class="col-sm-7 ph10">
                            <label for="subject" class="field prepend-icon">
                                ...
                                class="gui-input" value="<?php echo  $this->data['fielddata']->EmailSubject;?>" >
                    ...
                    <div class="section row mb10">
                        ...
                        <div class="col-sm-9 ph10">
                            <label for="message" class="field prepend-icon">
                                ...
                                <textarea name="message" id="message" placeholder="<?php echo  ucwords($this->lang->line('message')); ?>" class="ckeditor gui-input" ><?php echo  urldecode($this->data['fielddata']->EmailContent);?></textarea>
                    ...
                    <div class="section row mb10">
                        <label for="emailstatus"class="field-label col-sm-3 ph10 text-left"><?php echo  ucwords($this->lang->line('label_status')); ?><sup><em class="state-error"><?php echo  ucwords($this->lang->line('star')); ?></em></sup></label>
                        <div class="col-sm-7 ph10">
                       
                             <div class="option-group field">
                                    <label class="col-md-3 block mt15 option option-primary">
                                   <input type="radio"  <?php if(isset($this->data['fielddata']->EmailStatus)){ if($this->data['fielddata']->EmailStatus=='1'){ echo "checked='checked'";}else {echo'';}}?>  value='1' name="emailstatus">
                                    <span class="radio"></span><?php echo  ucwords($this->lang->line('on'))?></label>

                                    <label class="col-md-3 block mt15 option option-primary">
                                    <input type="radio"  <?php if(isset($this->data['fielddata']->EmailStatus)){if($this->data['fielddata']->EmailStatus=='0'){ echo "checked='checked'";}else {echo'';}}?> value='0' name="emailstatus">
                                    <span class="radio"></span><?php echo  ucwords($this->lang->line('off'))?></label>
                             </div>
                              <label for="emailstatus" class="field-icon"></label>
                             <?php echo form_error('emailstatus');?>
                        </div>
                    </div>
