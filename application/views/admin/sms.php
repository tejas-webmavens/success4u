    ...
    <div class="mw1000 center-block">
        ...
        <form method="post" action="" id="allcp-form" enctype="multipart/form-data">
            <div class="panel-heading">
                <span class="panel-title"><?php echo  ucwords($this->lang->line('pagetitle_sms')); ?></span>
            <span class="allcp-form"><a class="btn btn-primary pull-right" title="" data-toggle="tooltip" href="<?php echo base_url();?>admin/sms/setting" data-original-title="<?php echo  ucwords($this->lang->line('smsmsetting')); ?>"><i class="fa fa-cogs"></i></a></span>
            ...
            <div class="panel-body br-t">
                ...
                <div class="allcp-form theme-primary">
                 ...
                 <div class="section row mb10">
                        ...
                        class="field-label col-sm-3 ph10 text-left"><?php echo  ucwords($this->lang->line('selectuser')); ?></label>

                        <div class="col-md-9 ph10">
                        <?php 
                        
                            ?>
                        <label for="usernumbers" class="field select-multiple">
                            <select id="usernumbers" name="usernumbers[]" multiple="multiple" size="7" >
                            <!-- <option value="selected"><?php echo  ucwords($this->lang->line('all')); ?></option> -->
...
*/
                            for($i=0; $i<count($this->data['members']); $i++) {      
                                if($this->data['members'][$i]->Phone!="")
                                    {
                                ?>

                                 <option value="<?php echo $this->data['members'][$i]->Phone;?>" ><?php echo  ucwords($this->data['members'][$i]->UserName);?></option>
                           ...
                           <?php       } 
                                ...
                                <label for="usermailid" class="field-icon">
                                    <i class="fa "></i>
                                </label>
                             <?php echo form_error('usernumbers');?>
                        </div>
                    </div>
                    ...
                    <div class="section row mb10 ">
                        ...
                        <div class="col-sm-9 ph10">
                            <label for="message" class="field prepend-icon">
                                ...
                                <textarea name="message" id="message" style="width: 687px; height: 170px;" placeholder="<?php echo  ucwords($this->lang->line('message')); ?>" class="gui-input" ><?php echo set_value('message', isset($this->data['fielddata']->Message) ? urldecode($this->data['fielddata']->Message) : '');?></textarea>
