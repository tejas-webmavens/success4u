    ...
    <div class="mw1000 center-block">
        ...
        <form method="post" action="" id="allcp-form" enctype="multipart/form-data">
            <div class="panel-heading">
                <span class="panel-title"><?php echo  ucwords($this->lang->line('pagetitle_updatepassword')); ?></span>
            ...
            <div class="panel-body br-t">
                ...
                <div class="allcp-form theme-primary">
                    ...
                    <div class="section row mb10">
                        <label for="newpassword" class="field-label col-sm-3 ph10  text-left"><?php echo  ucwords($this->lang->line('newpassword')); ?><sup><em class="state-error"><?php echo  ucwords($this->lang->line('star')); ?></em></sup></label>

                        <div class="col-sm-7 ph10">
                            <label for="newpassword" class="field prepend-icon">
                                <input type="password" name="newpassword" id="newpassword" placeholder="<?php echo  ucwords($this->lang->line('newpassword')); ?>"
                                class="gui-input" value="" >
                                <label for="newpassword" class="field-icon">
                    ...
                    <div class="section row mb10">
                        <label for="repeatpassword" class="field-label col-sm-3 ph10  text-left"><?php echo  ucwords($this->lang->line('repeatpassword')); ?><sup><em class="state-error"><?php echo  ucwords($this->lang->line('star')); ?></em></sup></label>

                        <div class="col-sm-7 ph10">
                            <label for="repeatpassword" class="field prepend-icon">
                                <input type="password" name="repeatpassword" id="repeatpassword" placeholder="<?php echo  ucwords($this->lang->line('repeatpassword')); ?>"
                                class="gui-input" value="" >
                    ...
                    <div class="section row mb10">
                        <label for="currentpassword" class="field-label col-sm-3 ph10  text-left"><?php echo  ucwords($this->lang->line('cpassword')); ?><sup><em class="state-error"><?php echo  ucwords($this->lang->line('star')); ?></em></sup></label>

                        <div class="col-sm-7 ph10">
                            <label for="currentpassword" class="field prepend-icon">
                                <input type="password" name="currentpassword" id="currentpassword" placeholder="<?php echo  ucwords($this->lang->line('cpassword')); ?>"
                                class="gui-input" value="" >
                                <label for="currentpassword" class="field-icon">
                                    <i class="fa fa-info"></i>
                                </label>
                            </label>
