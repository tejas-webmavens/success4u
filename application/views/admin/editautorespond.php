    ...
    <div class="mw1000 center-block">
        ...
        <form method="post" action="" id="allcp-form" enctype="multipart/form-data">
            <div class="panel-heading">
                <span class="panel-title"><?php echo  ucwords($this->lang->line('pagetitle_editautorespond')); ?></span>
            ...
            <div class="panel-body br-t">
                ...
                <div class="allcp-form theme-primary">
                    ...
                    <div class="section row mb10">
                        ...
                        <div class="col-sm-7 ph10">
                            <label for="subject" class="field prepend-icon">
                                ...
                                class="gui-input" value="<?php echo  $this->data['fielddata']->Subject;?>" >
                    ...
                    <div class="section row mb10">
                        <label for="message" class="field-label col-sm-3 ph10  text-left"><?php echo  ucwords($this->lang->line('tagnote')); ?><sup><em class="state-error"><?php echo  ucwords($this->lang->line('star')); ?></em></sup></label>

                        <div class="col-sm-9 ph10">
                            <label for="message" class="field prepend-icon">
                                    <?php echo  $this->lang->line('tagdetails'); ?>
                            </label>
                    ...
                    <div class="section row mb10">
                        ...
                        <div class="col-sm-9 ph10">
                            <label for="message" class="field prepend-icon">
                                ...
                                <textarea name="message" id="message" placeholder="<?php echo  ucwords($this->lang->line('message')); ?>" class="ckeditor gui-input" ><?php echo  urldecode($this->data['fielddata']->Message);?></textarea>
                    ...
                    <div class="section row mb10">
                        ...
                        <div class="col-sm-7 ph10">
                            <label for="duration" class="field prepend-icon">
                                ...
                                class="gui-input" value="<?php echo  $this->data['fielddata']->Duration;?>" >
                    ...
                    <div class="section row mb10">
                        ...
                        <div class="col-sm-7 ph10">
                           <label for="limitation" class="field prepend-icon">
                                            <input type="text" id="limitation" name="limitation" class="gui-input fs13" placeholder="<?php echo  ucwords($this->lang->line('limitation_det')); ?>" value="<?php echo  $this->data['fielddata']->Limitation;?>">
                     ...
                     <!-- <div class="section row mb10">
                        ...
                        <div class="col-sm-9 ph10">
                            <label for="content" class="field prepend-icon">
                                ...
                                <textarea name="content" id="content" placeholder="<?php echo  ucwords($this->lang->line('content_det')); ?>" class="ckeditor gui-input" ><?php echo  $this->data['fielddata']->ContentsHtml;?></textarea>
                     ...
                     <div class="section row mb10">
                        ...
                        <div class="col-sm-8 ph10">
                             ...
                             <div class="option-group field">
                                    ...
                                    <input type="radio" <?php if(isset($this->data['fielddata']->Status)) { if($this->data['fielddata']->Status=='1'){ echo "checked='checked'";}}?> value='1' name="status">
                                    <span class="radio"></span>
                                        <?php echo  ucwords($this->lang->line('on'))?>
                                    </label>

                                    <label class="col-md-3 block mt15 option option-primary">
                                    <input type="radio" <?php if(isset($this->data['fielddata']->Status)) { if($this->data['fielddata']->Status=='0') { echo "checked='checked'"; }}?> value='0' name="status" >
                                    <span class="radio"></span>
