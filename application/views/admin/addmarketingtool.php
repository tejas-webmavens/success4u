    ...
    <div class="mw1000 center-block">
        ...
        <form method="post" action="" id="allcp-form" enctype="multipart/form-data">
            <div class="panel-heading">
                <span class="panel-title"><?php echo  ucwords($this->lang->line('pagetitle_addmarketingtext')); ?></span>
                ...
                <div class="allcp-form theme-primary">
                        ...
                        <div class="col-sm-8 ph10">
                             ...
                             <div class="option-group field">
                                    ...
                                    <span class="radio"></span>
                                     ...
                                     <label class="col-md-3 block mt15 option option-primary">
                                    <input type="radio" <?php if(isset($this->data['marketingtype'])) { if($this->data['MarketingType']=='document') { echo "checked='checked'"; }}?> value='document' name="marketingtype" onclick="changedocumenttype()">
                                    <span class="radio"></span>
                                        <?php echo  ucwords($this->lang->line('document'))?>
                                    </label>
                        </div>
                    ...
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                     <label class="col-md-7 ph10 block mt15 option option-primary">
                        <div class="fileupload-preview thumbnail mb20">
                            <?// <img data-src="holder.js/100%x100" alt="holder"> ?>
                            <img src="<?php echo base_url(); if(isset($this->data['MarketingImage'])){echo $this->data['MarketingImage']; }?>" alt="<?php echo ucwords($this->lang->line('marketingimage'));?>">
                    ...
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                     <label class="col-md-7 ph10 block mt15 option option-primary">
                        <div class="fileupload-preview thumbnail mb20">
                            <?// <img data-src="holder.js/100%x100" alt="holder"> ?>
                            <img src="<?php echo base_url(); if(isset($this->data['MarketingDocument'])){echo $this->data['MarketingDocument']; }?>" alt="<?php echo ucwords($this->lang->line('marketingdocument'));?>">
                        
                        </div>
                        <span class="btn btn-primary light btn-file btn-block ph5">
                            <span class="fileupload-new"><?php echo  ucwords($this->lang->line('uploaddocument')); ?></span>
                            <span class="fileupload-exists"><?php echo  ucwords($this->lang->line('uploaddocument')); ?></span>
