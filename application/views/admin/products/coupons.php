                ...
                <div class="col-md-12">
                    <div class="panel panel-visible" id="spy6">
                        ...
                        <div class="panel-body pn">
                            ...
                            <form method="post" action="<?php echo base_url().'admin/coupon/search';?>" name="search_form">

                                <div class="section row mb20">
                                    
                                    <div class="col-md-3 ph10">
                                        <h6 class="mb15"> <?php echo $this->lang->line('label_filter_name'); ?></h6>
                                        <label for="couponname" class="field prepend-icon">
                                            <input type="text" name="couponname" id="couponname" class="gui-input" placeholder="Coupon Name" value="<?php echo set_value('couponname');?>">
                                            <label for="couponname" class="field-icon">
                                    ...
                                    <div class="col-md-3 ph10 mt40">
                                        <a data-original-title="Clear Filter" href="<?php echo base_url().'admin/coupon';?>" data-toggle="tooltip" title="" class="btn btn-danger pull-right"><i class="fa fa-eraser"></i></a>
                                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td class=""><?php echo $row->CouponName;?></td>
                                        <td class=""><?php echo $row->CouponCode;?></td>
    ...
    $(document).ready(function() {
        ...
        $('.status').click(function() {
            if (!$(this).is(':checked')) {
                ...
                $.ajax({
                    type: 'post',
                    url:'<?php echo base_url();?>admin/coupon/inactive/'+id,
                    success : function()
                    {
                        console.log('sc');
                    }
                ...
                $.ajax({
                    type: 'post',
                    url:'<?php echo base_url();?>admin/coupon/active/'+id,
                    success : function(){
                        console.log('fail');
                    }
                });
