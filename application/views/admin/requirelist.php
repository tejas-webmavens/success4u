                    ...
                    <div class="panel panel-visible" id="spy6">
                        <div class="panel-heading">
                            ...
                            <div class="panel-title hidden-xs">
                                <?php echo ucwords($this->lang->line('pagetitle_register'));?>
                                <span class="allcp-form"><a class="btn btn-primary pull-right" title="" data-toggle="tooltip" href="<?php echo base_url();?>admin/registersetting/addfield" data-original-title="Add New"><i class="fa fa-plus"></i></a></span>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th class="va-m"><?php echo $this->lang->line('label_poisiton');?></th>
                                        <th class="va-m"><?php echo $this->lang->line('label_name');?></th>
                                        
                                        <th class="va-m"><?php echo $this->lang->line('label_enable');?></th>
                                        <th class="va-m"><?php echo $this->lang->line('label_require');?></th>
                                    ...
                                    <?php
                                        $customers = $this->data;
                                        $i=0;
                                        foreach ($customers['field']  as $row) {
                                            $i++;
                                    ?>
                                    <tr>
                                        ...
                                        <td class=""><?php echo $row->FieldPosition;?></td>
                                        <td class=""><?php echo $row->ReuireFieldName;?></td>
                                        
                                        
                                        <td class="allcp-form">
                                            <label class="block mt15 switch switch-primary">
                                                <input type="checkbox" <?php if($row->FieldEnableStatus=='1') echo 'checked'; ?> id="t<?php echo $row->RequireId;?>" name="enablestatus" class="enablestatus" value="<?php echo $row->RequireId;?>">
                                                <label data-off="OFF" data-on="ON" for="t<?php echo $row->RequireId;?>"></label>
                                        ...
                                        <td class="allcp-form">
                                            <label class="block mt15 switch switch-primary">
                                                <input type="checkbox" <?php if($row->ReuireFieldStatus=='1') echo 'checked'; ?> id="tr<?php echo $row->RequireId;?>" name="requirestatus" class="requirestatus" value="<?php echo $row->RequireId;?>">
                                        ...
                                        <td class="">
                                            ...
                                            <div class="btn-group text-right">
                                                ...
                                                <ul role="menu" class="dropdown-menu">
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/registersetting/editfield/'.$row->RequireId;?>">Edit</a>
                                                    </li>
    ...
    $(document).ready(function() {
        ...
        $('.enablestatus').click(function() {
            if (!$(this).is(':checked')) {
                ...
                $.ajax({
                    type: 'post',
                    url:'<?php echo base_url();?>admin/registersetting/disable/'+id,
                    success : function()
                    {
                        console.log('sc');
                        location.reload();
                ...
                $.ajax({
                    type: 'post',
                    url:'<?php echo base_url();?>admin/registersetting/enable/'+id,
                    success : function(){
                        console.log('fail');
                        location.reload();
                    }
