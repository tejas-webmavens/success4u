                ...
                <div class="col-md-12">
                    <div class="panel panel-visible" id="spy6">
                        <div class="panel-heading">
                            ...
                            <div class="panel-title hidden-xs">
                                <?php echo ucwords($this->lang->line('pagetitle_bplan'));?>
                                <span class="allcp-form"><a class="btn btn-primary pull-right" title="" data-toggle="tooltip" href="<?php echo base_url();?>admin/boardplansetting/addboardplan" data-original-title="Add New"><i class="fa fa-plus"></i></a></span>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th class="va-m"><?php echo $this->lang->line('boardsize');?></th>
                                        <th class="va-m"><?php echo $this->lang->line('label_name');?></th>
                                        <th class="va-m"><?php echo $this->lang->line('packagefee');?></th>
 ...
 -->                                        <th class="va-m"><?php echo $this->lang->line('label_action');?></th>
                                    ...
                                    <tr>
                                       <!--  <td class="text-center">
                                        ...
                                        <td class=""><?php echo $row->BoardWidth.' X '.$row->BoardDepth;?></td>
                                        <td class=""><?php echo $row->PackageName;?></td>
                                        <td class=""><?php echo $row->PackageFee;?></td>
                                         <!--  <td class="allcp-form">
                                        ...
                                        <td class="">
                                            ...
                                            <div class="btn-group text-right">
                                                ...
                                                <ul role="menu" class="dropdown-menu">
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/boardplansetting/editboardplan/'.$row->PackageId;?>"><?php echo ucwords($this->lang->line('edit'));?></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/boardplansetting/delete/'.$row->PackageId;?>"><?php echo ucwords($this->lang->line('delete'));?></a>
                                                    </li>
