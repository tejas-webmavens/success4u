    ...
    <div class="mw1000 center-block">
        ...
        <form method="post" action="" id="allcp-form" enctype="multipart/form-data">
            <div class="panel-heading">
                <span class="panel-title"><?php echo  ucwords($this->lang->line('pagetitle_addemailtemplate')); ?></span>
                  ...
                  <div class="section row mb10">
                        ...
                        <div class="col-sm-7 ph10">
                           <label for="page" class="field prepend-icon">
                                            <input type="text" id="page" name="page" class="gui-input fs13" placeholder="<?php echo  ucwords($this->lang->line('page')); ?>" value="">
                    ...
                    <div class="section row mb10">
                        ...
                        <div class="col-sm-7 ph10">
                           <label for="sender" class="field prepend-icon">
                                            <input type="text" id="sender" name="sender" class="gui-input fs13" placeholder="<?php echo  ucwords($this->lang->line('sender')); ?>" value="">
                                            <label class="field-icon">
                                                <i class="fa fa-user"></i>
                                            </label>
                                        </label>
                     ...
                     <div class="section row mb10">
                        ...
                        <div class="col-sm-7 ph10">
                             ...
                             <div class="option-group field">
                                   ...
                                   <input type="radio"  value='1' name="emailstatus">
                                    <span class="radio"></span><?php echo  ucwords($this->lang->line('on'))?></label>

                                    <label class="col-md-3 block mt15 option option-primary">
                                    <input type="radio" value='0' name="emailstatus">
