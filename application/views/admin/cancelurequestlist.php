                ...
                <div class="col-md-12">
                    <div class="panel panel-visible" id="spy6">
                        ...
                        <div class="panel-body pn">
                            ...
                            <form method="post" action="<?php echo base_url().'admin/epin/searchcancelepin';?>" name="search_form">
                                ...
                                <div class="section row mb20">
                                    ...
                                    <div class="col-md-3 ph10 mt40">
                                        <a data-original-title="Clear Filter" href="<?php echo base_url().'admin/epin/cancelurequests';?>" data-toggle="tooltip" title="" class="btn btn-danger pull-right "><i class="fa fa-eraser"></i></a>
                                    </div>
                                        ...
                                        <label class="field select">
                                            <select id="filter-categories" name="status">
                                                ...
                                                <option value="1" <?php if(isset($_POST['status'])) {if($_POST['status']==1) { echo "selected";}}?> ><?php echo ucwords($this->lang->line('used'));?></option>
                                                 --><option value="2" <?php if(isset($_POST['status'])) {if($_POST['status']==2) { echo "selected";}}?> ><?php echo ucwords($this->lang->line('cancel'));?></option>
                                            </select>
                ...
                <div class="col-md-12">
                    <div class="panel panel-visible" id="spy6">
                        <div class="panel-heading">
                            ...
                            <div class="panel-title hidden-xs">
                                <?php echo ucwords($this->lang->line('pagetitle_cancelurequestepin'));?>
                                        ...
                                        <td class="">
                                            ...
                                            <div class="btn-group text-right">
                                                ...
                                                <ul role="menu" class="dropdown-menu">
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/epin/canceldelete/'.$row->RequestId;?>"><?php echo ucwords($this->lang->line('deleteepin'));?></a>
                                                    </li>
