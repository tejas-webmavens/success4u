                ...
                <div class="col-md-12">
                    <div class="panel panel-visible" id="spy6">
                        <div class="panel-heading">
                            ...
                            <div class="panel-title hidden-xs">
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        <span class="allcp-form"><a class="btn btn-primary pull-right" title="" data-toggle="tooltip" href="<?php echo base_url();?>admin/banner/addbanner" data-original-title="Add New"><i class="fa fa-plus"></i></a></span>
                                    </div>
                        ...
                        <div class="panel-body pn">
                            ...
                            <form name="form-product" id="form-product" method="post" action="<?php echo base_url();?>/admin/banner">
                                <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    // print_r($this->data);
                                        ...
                                        foreach ($banner as $row) {
                                            ...
                                            if($row->banner_image) {
                                                // $product_image = explode(',', $row->banner_image);
                                                $pimage1 = base_url().$row->banner_image;
                                            } else {
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <label class="option block mn">
                                                <input type="checkbox" name="products[]" value="<?php echo $row->banner_id;?>" class="case">
                                                <span class="checkbox mn"></span>
                                            </label>
                                        </td>
                                        <td class="w100">
                                        ...
                                        <td class=""><?php echo $row->banner_image;?></td>
                                        ...
                                        <td class="allcp-form">
                                            <label class="block mt15 switch switch-primary">
                                                <input type="checkbox" <?php if($row->status=='1') echo 'checked'; ?> id="t<?php echo $row->banner_id;?>" name="status" class="status" value="<?php echo $row->banner_id;?>">
                                                <label data-off="OFF" data-on="ON" for="t<?php echo $row->banner_id;?>"></label>
                                        ...
                                        <td class="">
                                            ...
                                            <div class="btn-group text-right">
                                                ...
                                                <ul role="menu" class="dropdown-menu">
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/banner/edit/'.$row->banner_id;?>"><?php echo $this->lang->line('label_edit'); ?></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/banner/delete/'.$row->banner_id;?>"><?php echo $this->lang->line('label_delete'); ?></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
                                    <input type="hidden" name="banner_id" value="<?php isset($product->banner_id);?>">
                                    <?php 
                                            }
                                        } else {   
                                    ?>
