    ...
    <div class="mw1000 center-block">
        ...
        <form method="post" action="" id="allcp-form" enctype="multipart/form-data">
            <div class="panel-heading">
                <span class="panel-title"><?php echo  ucwords($this->lang->line('pagetitle_bplanadd')); ?></span>
                ...
                <div class="allcp-form theme-primary">
                     ...
                     <div class="section row mb10">
                        ...
                        <div class="col-sm-7 ph10">
                            <label for="packagefee" class="field prepend-icon">
                                ...
                                class="gui-input" value="<?php echo set_value('boardwidth', isset($this->data['BoardWidth']) ? $this->data['BoardWidth'] : '');?>" >
                     ...
                     <div class="section row mb10">
                        ...
                        <div class="col-sm-7 ph10">
                            <label for="boarddepth" class="field prepend-icon">
                                ...
                                class="gui-input" value="<?php echo set_value('boarddepth', isset($this->data['BoardDepth']) ? $this->data['BoardDepth'] : '');?>" >
                    ...
                    <div class="section row mb10">
                        ...
                        <div class="col-sm-5 ph10">
                             ...
                             <div class="option-group field">
                        <label class="col-md-4 block mt15 option option-primary">
                                    <input type="radio" value='1' name="followsponsor">
                                    <span class="radio"></span>
                                        <?php echo  ucwords($this->lang->line('enable'))?>
                                        </label>

                                    <label class="col-md-4 block mt15 option option-primary">
                                    <input type="radio" value='0' name="followsponsor">
                                    <span class="radio"></span>
                    ...
                    <div class="section row mb10">
                        ...
                        <label class="col-md-4 block mt15 option option-primary">
                                    ...
                                    <input type="radio" value='1' name="reentrystatus">
                                    <span class="radio"></span>
                                        <?php echo  ucwords($this->lang->line('enable'))?>
                                        </label>

                                    <label class="col-md-4 block mt15 option option-primary">
                                    <input type="radio" value='0' name="reentrystatus">
                                    <span class="radio"></span>
                                        <?php echo  ucwords($this->lang->line('disable'))?>
                        </label>
                        </div>
                   ...
                   <div class="section row mb10">
                        ...
                        <label class="col-md-4 block mt15 option option-primary">
                                    ...
                                    <input type="radio" value='1' name="reentrynextstatus">
                                    <span class="radio"></span>
                                        <?php echo  ucwords($this->lang->line('enable'))?>
                                        </label>

                                    <label class="col-md-4 block mt15 option option-primary">
                                    <input type="radio" value='0' name="reentrynextstatus">
                                    <span class="radio"></span>
                                        <?php echo  ucwords($this->lang->line('disable'))?>
                        </label>
                        </div>
                     ...
                     <div class="section row mb10">
                        <label for="nextbaordplan"
                        class="field-label col-sm-3 ph10 text-left"><?php echo  ucwords($this->lang->line('selectnextboard')); ?><sup><em class="state-error"><?php echo  ucwords($this->lang->line('star')); ?></em></sup></label>
...
*/
                            for($i=0; $i<count($this->data['boarddetail']); $i++) {      ?>
                                 ...
                                 <option value="<?php echo $this->data['boarddetail'][$i]->PackageId;?>" ><?php echo  ucwords($this->data['boarddetail'][$i]->PackageName);?></option>
                    ...
                    <div class="section row mb10">
                        ...
                        <div class="col-sm-7 ph10">
                            <label for="directcommission" class="field prepend-icon">
                                ...
                                class="gui-input" value="<?php echo set_value('directcommission', isset($this->data['directcommission']) ? $this->data['directcommission'] : '');?>" >
                     ...
                     <div class="section row mb10">
                        ...
                        <div class="col-sm-7 ph10">
                            <label for="boardcommission" class="field prepend-icon">
                                ...
                                class="gui-input" value="<?php echo set_value('boardcommission', isset($this->data['boardcommission']) ? $this->data['boardcommission'] : '');?>" >
                    ...
                    <div class="section row mb10" id="levelcommissiondiv">
                       ...
                       <div class="section row mb10" id="upgradecommissiondivp">
                            ...
                            <label for="upgradecommission" class="field-label col-sm-3 ph10 md10">
                             
                            </label>
                            <div class="col-sm-7 ph10 md10 " >
                            
                             <input type="text" name="upgradecommission[]" id="upgradecommission[]" placeholder="<?php echo  ucwords($this->lang->line('upgrade'));echo" 1 ".  ucwords($this->lang->line('comamount')); ?>"
                                class="gui-input" value="" >
                    ...
                    <div class="section row mb10" id="upgradecommissiondiv">
                                <div class="col-sm-7 ph10"></div>
                                <label for="upgradecommission" class="field prepend-icon col-sm-5 ">
