    ...
    <div class="mw1000 center-block">
        ...
        <form method="post" action="" id="allcp-form" enctype="multipart/form-data">
            <div class="panel-heading">
                <span class="panel-title"><?php echo  ucwords($this->lang->line('pagetitle_profile')); ?></span>
            ...
            <div class="panel-body br-t">
                ...
                <div class="allcp-form theme-primary">
                    ...
                    <!-- <div class="section row mb10">
                     ...
                     <div class="section row mb10" id="imagediv" >
                    <label for="profileimage"
                        class="field-label col-sm-3 ph10 text-left"><?php echo  ucwords($this->lang->line('profileimage')); ?></label>

                    <div class="fileupload fileupload-new" data-provides="fileupload">
                     <label class="col-md-7 ph10 block mt15 option option-primary">
                        <div class="fileupload-preview thumbnail mb20">
                            <?// <img data-src="holder.js/100%x100" alt="holder"> ?>
                            <img src="<?php echo base_url().'uploads/UserProfileImage/'; if(isset($this->data['ProfileImage'])){echo $this->data['ProfileImage']; }?>" alt="<?php echo ucwords($this->lang->line('profileimage'));?>">
                        ...
                        <span class="btn btn-primary light btn-file btn-block ph5">
                            ...
                            <input type="file"  name="profileimage" value="<?php if(isset($this->data['ProfileImage'])){echo $this->data['ProfileImage']; }?>">
                             </span>
