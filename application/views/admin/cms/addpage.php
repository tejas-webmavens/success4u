                    ...
                    <div role="tabpanel" id="" class="allcp-form theme-primary tab-pane">
                        <div class="panel">
                            ...
                            <div class="panel-body pn">
                                <form id="contentForm" method="post" action="<?php echo base_url();?>admin/pages/confirm">
                                    ...
                                    <div class="section mb10">
                                        <div class="panel-body pn of-h" id="summer-demo">
                                            <textarea id="summernote_text" name="content" class="ckeditor gui-input" style="display: none;"><?php echo set_value('content',isset($pages->pageContent) ? $pages->pageContent : ''); ?></textarea>
                                        </div>
                                    ...
                                    <div class="section">
                                        <div class="pull-right">
                                            <button class="btn btn-bordered btn-primary" type="submit"> <?php echo $this->lang->line('label_save');?></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
