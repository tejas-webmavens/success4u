    ...
    <div class="mw1000 center-block">
        ...
        <form method="post" action="" id="allcp-form" enctype="multipart/form-data">
            <div class="panel-heading">
                <span class="panel-title"><?php echo  ucwords($this->lang->line('pagetitle_ewallet')); ?></span>
            </div>
            ...
            <div class="panel-body br-t">
                ...
                <div class="allcp-form theme-primary">
                    ...
                    <div class="section row mb10">
                        ...
                        <div class="col-sm-5 ph10">
                            <label for="username" class="field prepend-icon">
                                ...
                                class="gui-input" value="<?php echo set_value('username', isset($this->data['username']) ? $this->data['username'] : '');?>" >
                    ...
                    <div class="section row mb10">
                        <label for="balance"
                        class="field-label col-sm-3 ph10 text-left"> <?php echo  ucwords($this->lang->line('balance')); ?></label>

                        <div class="col-sm-5 ph10">
                            <label for="balance" class="field prepend-icon">
                            
                                <input type="text" name="balance" id="balance" placeholder="<?php echo  ucwords($this->lang->line('balance')); ?>"
                                class="gui-input" value="<?php echo isset($this->data['balance']) ? $this->data['balance'] : ''?>"  readonly>
                                <label for="balance" class="field-icon" value="">
...
(function($) {
    ...
    $('.memberstatus').click(function() {
                ...
                $.ajax({
                    type: 'post',
                    url:'<?php echo base_url();?>admin/Ewallet/checkbalance/'+id,
                    success : function()
                    {
                        console.log('test');
                    }
