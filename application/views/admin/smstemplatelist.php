                ...
                <div class="col-md-12">
                    <div class="panel panel-visible" id="spy6">
                        <div class="panel-heading">
                            ...
                            <div class="panel-title hidden-xs">
                                <?php echo ucwords($this->lang->line('pagetitle_smstemplate'));?>
                                <span class="allcp-form"><a class="btn btn-primary pull-right" title="" data-toggle="tooltip" href="<?php echo base_url();?>admin/sms/updatesmstemplate" data-original-title="Add sms Template"><i class="fa fa-plus"></i></a></span>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th class="va-m"><?php echo $this->lang->line('label_page');?></th>
                                        <th class="va-m"><?php echo $this->lang->line('label_fromno');?></th>
                                        <th class="va-m"><?php echo $this->lang->line('label_fromname');?></th>
                                    ...
                                    <tbody>
                                    <?php
                                        $smstemplates = $this->data;
                                        if($smstemplates['smstemplates']) 
                                        {
                                        $i=0;
                                       foreach ($smstemplates['smstemplates']  as $row) {
                                             $i++;
                                    ?>
                                    <tr>
                                       <!--  <td class="text-center">
                                        ...
                                        <td class=""><?php echo $row->FromNo;?></td>
                                        <td class=""><?php echo $row->FromName;?></td>
                                        <td class="allcp-form">
                                            <label class="block mt15 switch switch-primary">
                                                <input type="checkbox" <?php if($row->SmsStatus=='1') echo 'checked'; ?> id="t<?php echo $row->SmsStatus;?>" name="enablestatus" class="enablestatus" value="<?php echo $row->SmsTemplateId;?>">
                                                <label data-off="OFF" data-on="ON" for="t<?php echo $row->SmsTemplateId;?>"></label>
                                        ...
                                        <td class="">
                                            ...
                                            <div class="btn-group text-right">
                                                ...
                                                <ul role="menu" class="dropdown-menu">
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/sms/updatesmstemplate/'.$row->SmsTemplateId;?>"><?php echo ucwords($this->lang->line('edit'));?></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/sms/deletesmstemplate/'.$row->SmsTemplateId;?>"><?php echo ucwords($this->lang->line('delete'));?></a>
                                                    </li>
    ...
    $(document).ready(function() {
        ...
        $('.enablestatus').click(function() {
            if (!$(this).is(':checked')) {
                ...
                $.ajax({
                    type: 'post',
                    url:'<?php echo base_url();?>admin/emailtemplate/disable/'+id,
                    success : function()
                    {
                        console.log('sc');
                    }
                ...
                $.ajax({
                    type: 'post',
                    url:'<?php echo base_url();?>admin/emailtemplate/enable/'+id,
                    success : function(){
                        console.log('fail');
                    }
                });
