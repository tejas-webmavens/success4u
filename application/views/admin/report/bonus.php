                ...
                <div class="col-md-12">
                    <div class="panel panel-visible" id="spy6">
                        ...
                        <div class="panel-body pn">
                            ...
                            <form method="post" action="<?php echo base_url().'admin/report/bonusSearch';?>" name="search_form">
                                ...
                                <div class="section row mb20">
                                    ...
                                    <div class="col-md-3 ph10">
                                     ...
                                     <div class="col-md-3 ph10 mt40">
                                        <a data-original-title="Clear Filter" href="<?php echo base_url().'admin/report/bonus';?>" data-toggle="tooltip" title="" class="btn btn-danger pull-right"><i class="fa fa-eraser"></i></a>
                                    </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-visible" id="spy6">
                        <div class="panel-heading">
                            ...
                            <div class="panel-title hidden-xs">
                                <?php echo ucwords($this->lang->line('report_bonus'));?>
                                ...
                                <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <?php 
                                        ...
                                        foreach ($rquests['field']  as $row) {
                                            $paythrough = ($row->paythrough) ? $row->paythrough : 'bankwire';
...
<script>
    $(function() {
        ...
        $("#btnExport").click(function(){
            ...
            download('<?php echo  $this->lang->line("report_bonus")."-".date("dMY");?>.xls', $( ".export_content .row:eq( 1 )" ).html());
        });
