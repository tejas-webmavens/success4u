                ...
                <div class="col-md-12">
                    <div class="panel panel-visible" id="spy6">
                        ...
                        <div class="panel-body pn">
                            ...
                            <form method="post" action="<?php echo base_url().'admin/report/commissionSearch';?>" name="search_form">
 ...
 -->
                                    ...
                                    <div class="col-md-3 ph10">
                                     ...
                                     <div class="col-md-3 ph10 mt40 ">
                                        <a data-original-title="Clear Filter" href="<?php echo base_url().'admin/report/commission';?>" data-toggle="tooltip" title="" class="btn btn-danger pull-right"><i class="fa fa-eraser"></i></a>
                                    </div>
