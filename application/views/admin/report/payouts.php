                ...
                <div class="col-md-12">
                    <div class="panel panel-visible" id="spy6">
                        ...
                        <div class="panel-body pn">
                            ...
                            <form method="post" action="<?php echo base_url().'admin/report/payoutSearch';?>" name="search_form">
                                ...
                                <div class="section row mb20">
                                    ...
                                    <div class="col-md-3 ph10">
                                      ...
                                      <div class="col-md-3 ph10 mt40">
                                        <a data-original-title="Clear Filter" href="<?php echo base_url().'admin/report/payout';?>" data-toggle="tooltip" title="" class="btn btn-danger pull-right"><i class="fa fa-eraser"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="table-responsive export_content">
                                <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td class=""><?php if($row->paythrough!=''){echo $row->paythrough;}else{echo"---";}?></td>
                                        <td class=""><?php if($row->PaymentReferenceId!=''){echo $row->PaymentReferenceId;}else{echo"---";}?></td>
...
<script>
    $(function() {
        ...
        $("#btnExport").click(function(){
            ...
            download('<?php echo  $this->lang->line("pagetitle_payout")."-".date("dMY");?>.xls', $( ".export_content .row:eq( 1 )" ).html());
        });
