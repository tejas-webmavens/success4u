                ...
                <div class="col-md-12">
                    <div class="panel panel-visible" id="spy6">
                        ...
                        <div class="panel-body pn">
                            ...
                            <form method="post" action="<?php echo base_url().'admin/epin/searchepin';?>" name="search_form">
                                ...
                                <div class="section row mb20">
                                    ...
                                    <div class="col-md-3 ph10 mt40">
                                        <a data-original-title="Clear Filter" href="<?php echo base_url().'admin/epin';?>" data-toggle="tooltip" title="" class="btn btn-danger pull-right "><i class="fa fa-eraser"></i></a>
                                    </div>
                                ...
                                <div class="section row mb20">
                                     <div class="col-md-3 ph10">
                                        ...
                                        <label class="field select">
                                            ...
                                            <?php //if(isset($_POST['status'])) { $status=$_POST['status'];}else{$status="";}?>
                                                ...
                                                <option value="1" <?php if($_POST['status']!=''){if($_POST['status']==1) { echo "selected";}}?> ><?php echo ucwords($this->lang->line('allocated'));?></option>
                                                <option value="2" <?php if($_POST['status']!=''){if($_POST['status']==2) { echo "selected";}}?> ><?php echo ucwords($this->lang->line('used'));?></option>
                                                <option value="3" <?php if($_POST['status']!=''){if($_POST['status']==3) { echo "selected";}}?> ><?php echo ucwords($this->lang->line('cancel'));?></option>
                                            </select>
                                    ...
                                    <div class="col-md-3 ph10">
                                     ...
                                     <div class="col-md-2 pull-right ph10">
                                    <h6 class="mb40"> </h6>
                ...
                <div class="col-md-12">
                    <div class="panel panel-visible" id="spy6">
                        <div class="panel-heading">
                            ...
                            <div class="panel-title hidden-xs">
                                <?php echo ucwords($this->lang->line('pagetitle_epin'));?>
                                ...
                                <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                       <!--  <td class="text-center">
                                        ...
                                        <td class=""><?php $user = $this->Epin_model->Getfielddata($row->EpinPackageId); if(isset($user->PackageName)){echo $user->PackageName;}else{ echo"--";}?></td>
                                        <td class=""><?php echo $row->EpinAmount;?></td>
                                        
                                        <td class=""><?php if($row->EpinStatus=='0') { echo $this->lang->line('unused'); } elseif($row->EpinStatus=='1') { echo $this->lang->line('allocated');} elseif($row->EpinStatus=='2') { echo $this->lang->line('used');}elseif($row->EpinStatus=='3') { echo $this->lang->line('cancel');} else { echo '---';}?></td>
                                       ...
                                       <?php if($row->EpinStatus=='0') {?>
                                               <div class="btn-group text-right">
                                                ...
                                                <ul role="menu" class="dropdown-menu">
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/epin/delete/'.$row->EpinRecordId;?>"><?php echo ucwords($this->lang->line('deleteepin'));?></a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <?php }?>
