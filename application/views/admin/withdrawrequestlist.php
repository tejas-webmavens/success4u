                ...
                <div class="col-md-12">
                    <div class="panel panel-visible" id="spy6">
                        ...
                        <div class="panel-body pn">
                            ...
                            <form method="post" action="<?php echo base_url().'admin/withdraw/searchrequest';?>" name="search_form">
                                ...
                                <div class="section row mb20">
                                    ...
                                    <div class="col-md-3 ph10 mt40">
                                        <a data-original-title="Clear Filter" href="<?php echo base_url().'admin/withdraw';?>" data-toggle="tooltip" title="" class="btn btn-danger pull-right"><i class="fa fa-eraser"></i></a>
                                    </div>
                                </div>
                    ...
                    <div class="panel panel-visible" id="spy6">
                        <div class="panel-heading">
                            ...
                            <div class="panel-title hidden-xs">
                                <div class="row">
                                    <div class="col-md-3">
                                        <?php echo ucwords($this->lang->line('pagetitle_request'));?>
                                    </div>
                                    <span class="allcp-form col-md-4">
                                        <form name="selectPayment" method="post" id="SelectPayment" action="<?php echo base_url();?>admin/withdraw/paymentFilter">
                                        <label for="paythrough" class="field select">
                                            <select onChange="SelectedPaymentFunc(this.value)" name="paymentname">
                                            <?php 
                                                $payments = $this->common_model->GetResults("PaymentStatus='1'","arm_paymentsetting");
                                            ...
                                            ?>
                                                <option value="" selected="selected"><?php echo ucwords($this->lang->line('filterpaythrough'));?></option>
                                                <?php for($i=0; $i<count($payments); $i++) { ?>
                                                <option value="<?php echo $payments[$i]->PaymentId;?>"><?php echo ucwords($payments[$i]->PaymentName);?></option>
                                                <?php }?>
                                            </select>
                                            <i class="arrow double"></i>
                                        </label>
                                    ...
                                    <span class="allcp-form pull-right col-md-2"><a class="btn btn-primary pull-right ml10" title="" data-toggle="tooltip" href="javascript:void(0)" onclick="changeall()" data-original-title="<?php echo ucwords($this->lang->line('markaspaid'));?>"><i class="fa fa-right"><?php echo ucwords($this->lang->line('markaspaid'));?></i></a></span>
                                    <span class="allcp-form pull-right col-md-2"><a class="btn btn-primary pull-right ml10" title="" data-toggle="tooltip" href="javascript:void(0)" onclick="paynow()" data-original-title="<?php echo ucwords($this->lang->line('payonline'));?>"><i class="fa fa-right"><?php echo ucwords($this->lang->line('payonline'));?></i></a></span>
                                </div>
                        ...
                        <div class="panel-body pn">
                            ...
                            <div class="table-responsive">
                                <form method="post" id="form-withdraw"  action="<?php if(isset($action)) echo $action;?>">
                                <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th class="va-m"><?php echo $this->lang->line('payamount');?></th>
                                    ...
                                    <tr>
                                        ...
                                        <td class=""><?php $userpay = json_decode($user->CustomFields); $cpay =strtolower($pay->PaymentName);  if($cpay=='bankwire'){ echo "bankwirename: ".$userpay->bankwirename."<br>bankwireA/c: ".$userpay->bankwireacno;}else{echo $userpay->$cpay;}?></td>
...
<script type="text/javascript">
 ...
 function changeall(){
    if($('.case:checked').length) {
        var url = "<?php echo base_url();?>admin/withdraw/changepaid";
        $('#form-withdraw').attr('action', url);
     confirm('Are you sure, Mark as paid ?') ? $('#form-withdraw').submit() : false;
    }
}
 function paynow(){
    if($('.case:checked').length) {
        // var url = "<?php echo base_url();?>admin/withdraw/payonline";
        // $('#form-withdraw').attr('action', url);
     confirm('Are you sure, pay now ?') ? $('#form-withdraw').submit() : false;
    }
}

function SelectedPaymentFunc(paymentid) {
    if(paymentid){
