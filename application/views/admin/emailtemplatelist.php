                ...
                <div class="col-md-12">
                    <div class="panel panel-visible" id="spy6">
                        <div class="panel-heading">
                            ...
                            <div class="panel-title hidden-xs">
                                <?php echo ucwords($this->lang->line('pagetitle_emailtemplate'));?>
                                <span class="allcp-form"><a class="btn btn-primary pull-right" title="" data-toggle="tooltip" href="<?php echo base_url();?>admin/emailtemplate/addemailtemplate" data-original-title="Add Email Template"><i class="fa fa-plus"></i></a></span>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th class="va-m"><?php echo $this->lang->line('label_fromemail');?></th>
                                    ...
                                    <tr>
                                       <!--  <td class="text-center">
                                        ...
                                        <td class=""><?php echo $row->FromEmailId;?></td>
                                        <td class=""><?php echo $row->FromName;?></td>
                                        <td class=""><?php echo $row->EmailSubject;?></td>
                                                                              
                                        <td class="allcp-form">
                                            <label class="block mt15 switch switch-primary">
                                                <input type="checkbox" <?php if($row->EmailStatus=='1') echo 'checked'; ?> id="t<?php echo $row->EmailTemplateId;?>" name="enablestatus" class="enablestatus" value="<?php echo $row->EmailTemplateId;?>">
                                                <label data-off="OFF" data-on="ON" for="t<?php echo $row->EmailTemplateId;?>"></label>
                                        ...
                                        <td class="">
                                            ...
                                            <div class="btn-group text-right">
                                                ...
                                                <ul role="menu" class="dropdown-menu">
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/emailtemplate/editemailtemplate/'.$row->EmailTemplateId;?>"><?php echo ucwords($this->lang->line('edit'));?></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/emailtemplate/delete/'.$row->EmailTemplateId;?>"><?php echo ucwords($this->lang->line('delete'));?></a>
                                                    </li>
