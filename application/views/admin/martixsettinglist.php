                ...
                <div class="col-md-12">
                    <div class="panel panel-visible" id="spy6">
                        <div class="panel-heading">
                            ...
                            <div class="panel-title hidden-xs">
                                <? echo ucwords($this->lang->line('pagetitle_mlmlist'));?>
                                <!--<span class="allcp-form"><a class="btn btn-primary pull-right" title="" data-toggle="tooltip" href="<?php echo base_url();?>admin/" data-original-title="Add New"><i class="fa fa-plus"></i></a></span>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th class="va-m"><?php echo $this->lang->line('label_matrixname');?></th>
                                        <th class="va-m"><?php echo $this->lang->line('label_directcommissionstatus');?></th>
                                        <th class="va-m"><?php echo $this->lang->line('label_levelcommissionstatus');?></th>
                                        <th class="va-m"><?php echo $this->lang->line('label_matrixstatus');?></th>
                                    ...
                                    <tr>
                                       <!--  <td class="text-center">
                                        ...
                                        <td class=""><?php echo $row->MatrixName;?></td>
                                         <td class="allcp-form">
                                            <label class="block mt15 switch switch-primary">
                                                <input type="checkbox" <?php if($row->DirectCommissionStatus=='1') echo 'checked'; ?> id="d<?php echo $row->Id;?>" name="denablestatus" class="denablestatus" value="<?php echo $row->Id;?>">
                                                <label data-off="OFF" data-on="ON" for="d<?php echo $row->Id;?>"></label>
                                                <span><?php //echo $row->MatrixStatus;?></span>
                                            </label>

                                        </td>
                                         <td class="allcp-form">
                                            <label class="block mt15 switch switch-primary">
                                                <input type="checkbox" <?php if($row->LevelCommissionStatus=='1') echo 'checked'; ?> id="l<?php echo $row->Id;?>" name="lenablestatus" class="lenablestatus" value="<?php echo $row->Id;?>">
                                                <label data-off="OFF" data-on="ON" for="l<?php echo $row->Id;?>"></label>
                                                <span><?php //echo $row->MatrixStatus;?></span>
                                            </label>
                                        ...
                                        <td class="allcp-form">
                                            <label class="block mt15 switch switch-primary">
                                                <input type="checkbox" <?php if($row->MatrixStatus=='1') echo 'checked'; ?> id="t<?php echo $row->Id;?>" name="enablestatus" class="enablestatus" value="<?php echo $row->Id;?>">
                                                <label data-off="OFF" data-on="ON" for="t<?php echo $row->Id;?>"></label>
                                                <span><?php //echo $row->MatrixStatus;?></span>
                                            </label>
                                        ...
                                        <td class="">
                                            ...
                                            <div class="btn-group text-right">
                                                ...
                                                <ul role="menu" class="dropdown-menu">
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/mlmsetting/editmlm/'.$row->Id;?>"><?php echo ucwords($this->lang->line('edit'));?></a>
                                                    </li>
...
(function($) {
    ...
    $(document).ready(function() {
        ...
        $('.enablestatus').click(function() {
           var result= confirm('If your change matrix status all matrix will reset. Are you sure?');
           if(result){
            if (!$(this).is(':checked')) {
                var id = $(this).val();
                ...
                $.ajax({
                    type: 'post',
                    url:'<?php echo base_url();?>admin/mlmsetting/enable/'+id,
                    success : function()
                    {
                        console.log('sc');
                        location.reload();
     ...
     $(document).ready(function() {
        // console.log('sdsd');
        $('.denablestatus').click(function() {
            if (!$(this).is(':checked')) {
                var id = $(this).val();
              
                $.ajax({
                    type: 'post',
                    url:'<?php echo base_url();?>admin/mlmsetting/drtdisable/'+id,
                    success : function()
                    {
                        console.log('sc');
                        location.reload();
                ...
                $.ajax({
                    type: 'post',
                    url:'<?php echo base_url();?>admin/mlmsetting/drtenable/'+id,
                    success : function(){
                        // location.reload();
                        console.log('fail');
                    }
      ...
      $(document).ready(function() {
        // console.log('sdsd');
        $('.lenablestatus').click(function() {
            if (!$(this).is(':checked')) {
                var id = $(this).val();
              
                $.ajax({
                    type: 'post',
                    url:'<?php echo base_url();?>admin/mlmsetting/lvldisable/'+id,
                    success : function()
                    {
                        console.log('sc');
                        location.reload();
                ...
                $.ajax({
                    type: 'post',
                    url:'<?php echo base_url();?>admin/mlmsetting/lvlenable/'+id,
                    success : function(){
                        location.reload();
                        console.log('fail');
                    }
