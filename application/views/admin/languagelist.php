                    ...
                    <div class="panel panel-visible" id="spy6">
                        <div class="panel-heading">
                            ...
                            <div class="panel-title hidden-xs">
                                <?php echo ucwords($this->lang->line('pagetitle_language'));?>
                                <span class="allcp-form"><a class="btn btn-primary pull-right" title="" data-toggle="tooltip" href="<?php echo base_url();?>admin/languagesetting/updatelanguage" data-original-title="Add New"><i class="fa fa-plus"></i></a></span>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th class="va-m"><?php echo $this->lang->line('label_flag');?></th>
                                        <th class="va-m"><?php echo $this->lang->line('label_defaultlanguage');?></th>
                                    ...
                                    <tr>
                                        ...
                                        <td class=""><?php echo $row->LanguageName;?></td>
                                        <td class=""><?php echo $row->LanguageCode;?></td>
                                        <td class=""><img alt="LanguageImage" src="../<?php echo $row->LanguageImage; ?>" width="70px" height="40"></td>
                                        <td class="allcp-form">
                                            <label class="block mt15 switch switch-primary">
                                                <input type="checkbox" <?php if($row->Status=='1') echo 'checked'; ?> id="t<?php echo $row->LanguageId;?>" name="enablestatus" class="enablestatus" value="<?php echo $row->LanguageId;?>">
                                                <label data-off="OFF" data-on="ON" for="t<?php echo $row->LanguageId;?>"></label>
                                        ...
                                        <td class="">
                                            ...
                                            <div class="btn-group text-right">
                                                ...
                                                <ul role="menu" class="dropdown-menu">
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/languagesetting/updatelanguage/'.$row->LanguageId;?>"><?php echo ucwords($this->lang->line('edit'));?></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/languagesetting/delete/'.$row->LanguageId;?>"><?php echo ucwords($this->lang->line('delete'));?></a>
                                                    </li>
    ...
    $(document).ready(function() {
        ...
        $('.enablestatus').click(function() {
            if (!$(this).is(':checked')) {
                ...
                $.ajax({
                    type: 'post',
                    url:'<?php echo base_url();?>admin/languagesetting/enable/'+id,
                    success : function()
                    {
                        console.log('sc');
                        location.reload();
