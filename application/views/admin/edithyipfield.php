        ...
        <section id="content_wrapper">
            ...
            <section id="content" class="table-layout animated fadeIn">
                ...
                <div class="chute chute-center">
                    ...
                    <span class="panel-title"><?echo ucwords($this->lang->line('pagetitle_hyipedit')); ?></span>
                    <span class="allcp-form"><a class="btn btn-primary pull-right" title="" data-toggle="tooltip" href="<?php echo base_url();?>admin/hyipsetting" data-original-title="Back"><i class="fa fa-close"></i></a></span>
                            ...
                            <div class="col-sm-7 ph10">
                                <label for="packagemin" class="field prepend-icon">
                                    <input type="text" name="packagemin" id="packagemin" placeholder="<?echo ucwords($this->lang->line('packegemax')); ?>"
                                    class="gui-input" value="<? echo set_value('packagemin', isset($this->data['fielddata']->min_amount) ? $this->data['fielddata']->min_amount : '');?>" >
                         ...
                         <div class="section row mb10">
                            ...
                            <div class="col-sm-7 ph10">
                                <label for="packagemax" class="field prepend-icon">
                                    <input type="text" name="packagemax" id="packagemax" placeholder="<?echo ucwords($this->lang->line('packagefee')); ?>"
                                    class="gui-input" value="<? echo set_value('packagemax', isset($this->data['fielddata']->max_amount) ? $this->data['fielddata']->max_amount : '');?>" >
                          ...
                          <div class="section row mb10">
                            ...
                            <div class="col-sm-7 ph10">
                                <label for="duration" class="field prepend-icon">
                                    <input type="text" name="duration" id="duration" placeholder="<?echo ucwords($this->lang->line('packagefee')); ?>"
                                    class="gui-input" value="<? echo set_value('duration', isset($this->data['fielddata']->duration) ? $this->data['fielddata']->duration : '');?>" >
                          ...
                          <div class="section row mb10">
                            ...
                            <div class="col-sm-7 ph10">
                                <label for="interest" class="field prepend-icon">
                                    ...
                                    class="gui-input" value="<? echo set_value('interest', isset($this->data['fielddata']->interest) ? $this->data['fielddata']->interest : '');?>" >
                                    <label for="duration" class="field-icon">
                                        <i class="fa fa-money"></i>
                                    </label>
                                </label>
            ...
            class="field-label col-sm-3 ph10 text-left"><?echo ucwords($this->lang->line('workingdaysstatus')); ?><sup><em class="state-error"><?echo ucwords($this->lang->line('star')); ?></em></sup></label>
            ...
            <label class="col-md-4 block mt15 option option-primary">
                        ...
                        <input type="radio" value='1' <?if($this->data['fielddata']->workingdays==1){echo"checked";} ?> name="workingdaysstatus">
                        <span class="radio"></span>
                            <?echo ucwords($this->lang->line('enable'))?>
                            </label>

                        <label class="col-md-4 block mt15 option option-primary">
                        <input type="radio" value='0' <?if($this->data['fielddata']->workingdays==0){echo"checked";} ?> name="workingdaysstatus">
                        <span class="radio"></span>
                ...
                <?php echo form_error('workingdaysstatus');?>
                                        ...
                                        <div class="section row mb10">
                                            ...
                                            <div class="col-sm-7 ph10">
                                                <div class="option-group field">
                                                    <label class="col-md-4 block mt15 option option-primary">
                                                        <input type="radio" value='1' <?if($this->data['fielddata']->PairCommissionStatus==1){echo"checked";} ?> name="paircommissionstatus">
                                                        <span class="radio"></span> <?php echo  ucwords($this->lang->line('enable'))?>
                                                    </label>
                                                    <label class="col-md-4 block mt15 option option-primary">
                                                        <input type="radio" value='0' <?if($this->data['fielddata']->PairCommissionStatus==0){echo"checked";} ?> name="paircommissionstatus">
                                        ...
                                        <div class="section row mb10">
                                            ...
                                            <div class="col-sm-7 ph10">
                                                ...
                                                <div class="option-group field">
                                                    <label class="col-md-4 block mt15 option option-primary">
                                                        <input type="radio" value='1' <?if($this->data['fielddata']->PairCommissionType==1){echo"checked";} ?> name="paircommissiontype">
                                                        <span class="radio"></span> <?php echo  ucwords($this->lang->line('flatamount'))?>
                                                    </label>

                                                    <label class="col-md-4 block mt15 option option-primary">
                                                        <input type="radio" value='2'<?if($this->data['fielddata']->PairCommissionType==2){echo"checked";} ?>  name="paircommissiontype">
                                                        <span class="radio"></span> <?php echo  ucwords($this->lang->line('percentage'))?>
                                                    </label>

                                                    <label class="col-md-4 block mt15 option option-primary">
                                                        <input type="radio" value='3' <?if($this->data['fielddata']->PairCommissionType==3){echo"checked";} ?> name="paircommissiontype">
            ...
            <div class="col-sm-7 ph10">
                <label for="dailymaximumhyip" class="field prepend-icon">
                ...
                <?php echo form_error('dailymaximumhyip');?>
                                        ...
                                        <?
                                        $lvlpv =explode(",",$this->data['fielddata']->hyip);
                                        for($i=0;$i<count($lvlpv);$i++)
                                        {
                                            ...
                                            <div class="section row mb10" id="<?php echo"pv".$lvl;?>">
                                                ...
                                                <div class="col-sm-7 ph10 mb10" id="<?php echo"pv".$lvl;?>">
                                                    <input type="text" name="pv[]" id="pv[]" placeholder="<?php echo  ucwords($this->lang->line('level'));echo $lvl." ". ucwords($this->lang->line('lbl_hyip')); ?>" class="gui-input" value="<?php echo $lvlpv[$i];?>" >
                                                </div>
                                            </div>
