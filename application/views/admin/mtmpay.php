                ...
                <div class="col-md-12">
                    <div class="panel panel-visible" id="spy6">
                        ...
                        <div class="panel-body pn">
                            ...
                            <form method="post" action="<?php echo base_url().'admin/mtmpay/search';?>" name="search_form">
                                ...
                                <div class="section row mb20">
                                    ...
                                    <button class="btn btn-primary pull-right ph10 ml20 " type="submit" name="search"><?php echo $this->lang->line('btn_filter_search'); ?></button>
                                        <a data-original-title="Clear Filter" href="<?php echo base_url().'admin/mtmpay';?>" data-toggle="tooltip" title="" class="btn btn-danger pull-right ml20"><i class="fa fa-eraser lm20"></i></a>
                                ...
                                <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if($row->APaymentAttachemt!='') {?>
                                            ...
                                            <?php if($row->APaymentReference!=''){echo $row->APaymentReference;}else{echo"--";} echo"</a>";}
                                            else{
                                        ...
                                        <td class="">
                                            ...
                                            <div class="btn-group text-right">
                                                ...
                                                <?php if($row->AdminStatus=='0'){?>
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/mtmpay/accept/'.$row->Payid;?>"><?php echo ucwords($this->lang->line('label_accept')); ?></a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/mtmpay/decline/'.$row->Payid;?>"><?php echo ucwords($this->lang->line('label_decline')); ?></a>
                                                    </li>
                                                    <?php }?>
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/mtmpay/delete/'.$row->Payid;?>"><?php echo ucwords($this->lang->line('label_delete')); ?></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td> 
