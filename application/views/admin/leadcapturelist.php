                    ...
                    <div class="panel panel-visible" id="spy6">
                        <div class="panel-heading">
                            ...
                            <div class="panel-title hidden-xs">
                                <?php echo ucwords($this->lang->line('pagetitle_leadcapturepage'));?>
                                <span class="allcp-form"><a class="btn btn-primary pull-right ml10" title="" data-toggle="tooltip" href="<?php echo base_url();?>admin/leadcapture/addleadpage" data-original-title="Add New"><i class="fa fa-plus"></i></a></span>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th class="va-m"><?php echo $this->lang->line('label_title');?></th>
                                        <th class="va-m"><?php echo $this->lang->line('label_link');?></th>
                                    ...
                                    <tr>
                                       <!--  <td class="text-center">
                                        ...
                                        <td class=""><?php echo $row->PageName;?></td>
                                        <td class=""><?php echo $row->PageUrl;?></td>
                                        <!-- <td class=""><?php echo substr($row->Message, 0, 30)?></td> -->
                                        
                                        <td class="allcp-form">
                                            <label class="block mt15 switch switch-primary">
                                                <input type="checkbox" <?php if($row->Status=='1') echo 'checked'; ?> id="t<?php echo $row->LeadPageId;?>" name="enablestatus" class="enablestatus" value="<?php echo $row->LeadPageId;?>">
                                                <label data-off="OFF" data-on="ON" for="t<?php echo $row->LeadPageId;?>"></label>
                                        ...
                                        <td class="">
                                            ...
                                            <div class="btn-group text-right">
                                                ...
                                                <ul role="menu" class="dropdown-menu">
                                                    <!-- <li>
                                                        <a href="<?php echo base_url().'admin/leadpage/updateleadpage/'.$row->LeadPageId;?>"><?php echo ucwords($this->lang->line('edit'));?></a>
                                                    </li> -->
                                                    <li>
                                                        <a href="<?php echo base_url().'admin/leadcapture/delete/'.$row->LeadPageId;?>"><?php echo ucwords($this->lang->line('delete'));?></a>
                                                    </li>
    ...
    $(document).ready(function() {
        ...
        $('.enablestatus').click(function() {
            if (!$(this).is(':checked')) {
                ...
                $.ajax({
                    type: 'post',
                    url:'<?php echo base_url();?>admin/leadcapture/disable/'+id,
                    success : function()
                    {
                        console.log('sc');
                    }
                ...
                $.ajax({
                    type: 'post',
                    url:'<?php echo base_url();?>admin/leadcapture/enable/'+id,
                    success : function(){
                        console.log('fail');
                    }
                });
