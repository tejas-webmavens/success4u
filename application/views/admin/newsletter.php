    ...
    <div class="mw1000 center-block">
        ...
        <form method="post" action="" id="allcp-form" enctype="multipart/form-data">
            <div class="panel-heading">
                <span class="panel-title"><?php echo  ucwords($this->lang->line('pagetitle_newsletter')); ?></span>
            <span class="allcp-form"><a class="btn btn-primary pull-right" title="" data-toggle="tooltip" href="<?php echo base_url();?>admin/" data-original-title="Home"><i class="fa fa-close"></i></a></span>
                ...
                <div class="allcp-form theme-primary">
                 ...
                 <div class="section row mb10">
                        ...
                        <?php 
                            ...
                            ?>
                        <label for="usermailid" class="field select-multiple">
                            <select id="usermailid" name="usermailid[]" multiple="multiple" size="7" >
...
*/
                            for($i=0; $i<count($this->data['members']); $i++) {      ?>
                                 ...
                                 <option value="<?php echo $this->data['members'][$i]->Email;?>" ><?php echo  ucwords($this->data['members'][$i]->UserName);?></option>
                           ...
                           <?php } ?>
                             ...
                             <?php echo form_error('usermailid');?>
                        </div>
                    </div>
