...
?>
  <div class="panel-body row">
    <form method="post" action="<?php echo $coinpayment->PaymentLiveUrl;?>" role="form" id="coform">
      ...
      <input type="hidden" name="currency" value="<?php echo strtoupper($this->data['m_curr']); ?>">
      <input type="hidden" name="amountf" value="<?php echo $this->data['m_amount']; ?>">
      <input type="hidden" name="item_name" value="Deposit">
      <input type="hidden" name="item_number" value="<?php echo $this->data['m_orderid'];?>">
      <!-- <input type="hidden" name="on1" value="<?php echo $form_deposit['uusersid'];?>"> -->
