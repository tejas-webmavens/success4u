				...
				<div class="row">
                    ...
                    <ul>
                        ...
                        <?php
							...
							?>
                        <li>
                            <a href="#"><?php echo  urldecode($row->FaqQuestion);?><span class="st-arrow">Open or Close</span></a>
							...
							?>
						                ...
						                <li>
						                  	...
						                  	<div class="timeline-item">
						                    	...
						                    	<h3 class="timeline-header"><a href="javascript:void(0)"><?php echo  urldecode($row->FaqQuestion);?></a><?php echo  ucwords($this->lang->line('type'));?> : <?php echo  $row->Type;?></h3>
						                    	<div class="timeline-body">
							                      <?php echo urldecode($row->FaqAnswer);?>
							                    </div>
