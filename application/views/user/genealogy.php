																		...
																		<div class="regform">
																		 	...
																		 	<?php if($mlsetting->Id==5 || $mlsetting->Id==8)
																				{ 	
																					for($i=0; $i< $bplan->num_rows(); $i++)
																					{  ?>
																				   <iframe class="col-lg-12 genview" style ="display:none;"  id="<?php echo  "gen_".$i;?>" width="1050px" height="700px" src="<?php echo base_url()."genealogy/".$path;?>/genealogyview/view/<?php  echo $bplan->row($i)->BoardId?>/<?php echo $id;?>" style="padding-top:5px; margin-top:-80px;  margin-right: 2px;"></iframe>
																			...
																			elseif($mlsetting->Id==4){	?>
																				   ...
																				   <iframe class="col-md-12" height="700px" src="<?php echo base_url()."genealogy/".$path;?>/genealogyview1/view/<?php echo $this->session->MemberID?>" style="padding-top:5px; margin-top:-80px;  margin-right: 2px;"></iframe>
                                 											<?php 	}	
                                 											else
                                 											{?>
                                 												 <iframe class="col-md-12" height="700px" src="<?php echo base_url()."genealogy/".$path;?>/genealogyview/view/<?php echo $this->session->MemberID?>" style="padding-top:5px; margin-top:-80px;  margin-right: 2px;"></iframe>
                                 										<?php } ?>
