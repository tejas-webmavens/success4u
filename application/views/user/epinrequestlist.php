								...
								<div class="col-xs-12">
										<div class="box">
												<div class="box-header with-border">
														<h3 class="box-title"><?php echo  ucwords($this->lang->line('pagetitle_requestepin'));?></h3>
														...
														<table id="example1" class="table table-bordered table-striped">
																<thead>
																		<tr>
																				...
																				<th><?php echo  ucwords($this->lang->line('label_request'));?></th>
																				<th><?php echo  ucwords($this->lang->line('label_package'));?></th>
																				<th><?php echo  ucwords($this->lang->line('label_fee'));?></th>
																				<th><?php echo  ucwords($this->lang->line('label_paythrough'));?></th>
																				<th><?php echo  ucwords($this->lang->line('label_payreference'));?></th>
																...
																<?php 	$i=1;
																  ...
																  while( $i< count($this->data['field']) ){
																   ...
																   ?>
																		<tr>
																				<td><?php echo  $i;?></td>
																				<td><?php echo  $this->data['field'][$j]->EpinCount;?></td>
																				<td><?php $user = $this->epin_model->Getfielddata($this->data['field'][$j]->PackageId); if($user!=''){echo $user->PackageName;}else{echo"--";}?></td>
																				<td><?php echo  $this->data['field'][$j]->PackageFee;?></td>
																				<td><?php echo  ucwords($this->data['field'][$j]->PayThrough);?></td>
																				<td><?php echo  $this->data['field'][$j]->PaymentReference;?></td>
																				<td><?php $EpinStatus=$this->data['field'][$j]->RequestStatus; if($EpinStatus=='0') { echo ucwords($this->lang->line('request')); } elseif($EpinStatus=='2') {echo ucwords($this->lang->line('cancel'));} else { echo '---';}?></td>
