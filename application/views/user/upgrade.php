		...
		<div class="content-wrapper">
				<section class="content">
						<!-- <section class="content-header">
								<ol class="breadcrumb">
										<li><a href="<?echo base_url().'user';?>"> <i class="fa fa-dashboard"></i> DASHBOARD</a></li>
								...
								<div class="col-md-12">
										<div class="box">
												<div class="box-header with-border">
														<h3 class="box-title"><?echo ucwords($this->lang->line('pagetitle'));?></h3>
														...
														<div class="row">
																<div class="prfle">
             															...
             															<? if(isset($packages)){
             																...
             																{?>
             																	<div class="row text-center mt10">					
                               								  							<? echo ucwords($this->lang->line("pendingupgrademsg"));?><a href="<?echo base_url();?>user/dashboard"><? echo ucwords($this->lang->line("dashboard"));?></a>
                              														</div>
																		...
																		<div class="col-md-6">
																		 ...
																		 <!-- <form method="post" action="" class="form" id="form-register" name="registerform" autocomplete="off"> -->
																				<div class="dshfrom"><br>
															                            ...
															                            <h3><?echo ucwords($this->lang->line('selectpackage')); ?></h3>

															                             <select id="package" name="package" class="form-control" required >
															                                    <option value="" selected="selected"><?php //echo $this->lang->line('label_country');?><?echo ucwords($this->lang->line('selectpackage'));?> </option>
															                                    <?php
															                                ...
															                                ?>
															                            </select> <h4><?echo form_error('package');?></h4>
															                            ...
															                            <h3><?echo ucwords($this->lang->line('paythrough')); ?></h3>
															                             ...
															                             <select id="paythrough" name="paythrough" class="form-control" required onChange="PaymentMethod(this.value)">
															                                    <option value="" selected="selected"><?php //echo $this->lang->line('label_country');?><?echo ucwords($this->lang->line('select'));?> </option>
															                                    <?php
															                                ...
															                                <option value="Currentbalance">CurrentBalance</option>
															                            </select> 
															                            <h4><?echo form_error('paythrough');?></h4>
															                           <!--  <input type="submit" value="<?echo ucwords($this->lang->line('upgradenow')); ?>"/> -->
																				</div>
																		...
																		<? } 
																				  	...
																				  	<div class="row text-center mt10">					
                               								  							<? echo ucwords($this->lang->line("noupgrademsg"));?><a href="<?echo base_url();?>user/dashboard"><? echo ucwords($this->lang->line("dashboard"));?></a>
                              														</div>
																				  		<? } ?>
																</div>
														</div>
...
function PaymentMethod(payment) {
	...
	// {
 //           html='<input type="text" name="current" value="">';
 //           $('#bal').append(html);
	...
	if(a && payment){
       // alert(payment);
        var url = '<?php echo base_url();?>payment/'+payment+'/upgrade';
        $.ajax({
            url: url,
            type: 'post',
