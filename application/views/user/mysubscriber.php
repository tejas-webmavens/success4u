								...
								<div class="col-xs-12">
										<div class="box">
												<div class="box-header with-border">
														<h3 class="box-title"><?php echo  ucwords($this->lang->line('page_title'));?></h3>
													...
													<table id="example1" class="table table-bordered table-striped">
														<thead>
															...
															<tr>
						                                        ...
						                                        <th class="va-m"><?php echo $this->lang->line('label_email'); ?></th>
														...
														<tbody>
						                                    <?php
						                                        $mysubscriber = $this->data['mysubscriber'];
						                                        if($mysubscriber) {
						                                        foreach ($mysubscriber as $row) {
						                                    ?>
						                                    <tr>
						                                        
						                                        <td class=""><?php echo $this->session->userdata('full_name');?></td>
						                                        <td class=""><?php echo $row->MailId;?></td>
						                                        <td class=""><?php echo ($row->Status) ? 'Enabled' : 'Disabled';?></td>
						                                        ...
						                                        <td class="">
						                                            <div class="btn-group text-right">
						                                                ...
						                                                <ul role="menu" class="dropdown-menu">
						                                                   <li>
						                                                        <a href="<?php echo base_url().'admin/myscuscriber/delete/'.$row->id;?>"><?php echo $this->lang->line('label_delete'); ?></a>
						                                                    </li>
						                                                </ul>
						                                            </div>
						                                        </td>
