														...
														<table id="example1" class="table table-bordered table-striped">
																...
																<th colspan="3"><?php echo  ucwords($this->lang->line('label_amount'));?></th>
																		...
																		<tr>
																				...
																				<th><?php echo  ucwords($this->lang->line('description'));?></th>
																				<th><?php echo  ucwords($this->lang->line('amount'));?></th>
																				<th><?php echo  ucwords($this->lang->line('metureddate'));?></th>
																...
																?>
																		...
																		<tr>
																				...
																				<td><?php echo  $CurrencySymbol." ".$row->amount;?></td>
																				
																				<td><?php echo $row->mechureddate?></td>

																				<!-- <td><a href="<?php echo base_url().'user/deposit/closedeposit/'.$row->id;?>"><button>Close Deposit</button></a></td> -->
