		...
		<div class="content-wrapper">
				<section class="content">
								...
								<div class="box-body">
										<section class="content-header">
												<ol class="breadcrumb">
														...
														<li><a href="#"> <i class="fa fa-database"></i><?php echo  ucwords($this->uri->segment(2)); ?></a></li>
														<li class="active"> <i class="fa fa-dedent"></i> <?php echo  ucwords($this->lang->line('pagetitle_buyepin'));?></li>
												</ol>
										</section>
								</div>
						</div>
						...
						<div class="row">
												...
												<div class="box-body">
														<div class="row">
																<div class="prfle">
																		...
																		<div class="col-md-6">
																		<?php print_r($epindetails);?>

																		<h3><?php echo  ucwords($this->lang->line('package'));?> : <strong><span><?php echo $epindetails['package']->PackageName; ?></span></strong></h3> 
																		<h3><?php echo  ucwords($this->lang->line('epincount'));?> : <strong><span><?php echo $epindetails['epincount']; ?></span></strong></h3> 
																		<h3><?php echo  ucwords($this->lang->line('amount'));?> : <strong><span><?php echo $epindetails['totalamount']; ?></span></strong></h3>
																		<!-- <h3><?php echo  ucwords($this->lang->line('payby'));?> :  <img  width="70px" height="30" src="<?php echo base_url();?>uploads/payment/paypal.jpg"> </h3>
																		 -->
																		<?php

                                if($paymentdetails->PaymentName=='paypal')
                                {
                           ...
                           <form name="paypalFrm" id="paypalFrm" action="<?php echo $paymemturl;?>" method="post" target="_blank">
                               <hr class="hrzntl"/>
                                <input type="hidden" name="cmd" value="_xclick">
                                <input type="hidden" name="return" value="<?php echo base_url();?>user/epin/paymentsuccess">
                                ...
                                <input type="hidden" name="custom" value="<?php echo 'epin,paypal,'.$epindetails['epincount'];?>">
                                <input type="hidden" name="business" value="<?php echo $paymentdetails->PaymentMerchantId;?>">
                                <input type="hidden" name="item_name" value="<?php echo $epindetails['package']->PackageName; ?>">
                                <input type="hidden" name="item_number" value="<?php echo $epindetails['packageid'];?>">
                                <input type="hidden" name="amount" value="<?php echo $epindetails['totalamount'];?>">
                                <input type="hidden" name="currency_code" value="USD">
                                <input type="hidden" name="username" value="<?php echo $userdetails->UserName;?>">
                               
                                <button><img src="<?php echo base_url().$paymentdetails->PaymentLogo;?>"><br></button>
