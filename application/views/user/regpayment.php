                ...
                <div class="bskt">
                    <div class="row">
                        <div class="col-xs-8">
                            ...
                            <h2>Users <span><strong>payment</strong></span></h2>
                            <h3></h3>

                            
                            <?php
                                if($userdetails->SubscriptionsStatus == 'Free'){
                                                ...
                                                foreach ($paymentdetails as $row) {
                                                    if($row->PaymentStatus)
                                                    {
                                                        ...
                                                        <div class="radio-list">
                                                            <option value="<?php echo $row->PaymentName;?>"><?php echo ucfirst($row->PaymentName);?></option>
                                                        </div>
                                                    <?php
                                                    }
                                                }
...
<script type="text/javascript">
    ...
    function PaymentMethod(payment) {
        if(payment) {
            var url = '<?php echo base_url();?>payment/'+payment+'/register';
            $.ajax({
                url: url,
                type: 'post',
