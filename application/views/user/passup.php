								...
								<div class="col-xs-12">
										<div class="box">
												<div class="box-header with-border">
														<h3 class="box-title"><?php echo  ucwords($this->lang->line('pagetitle_receive'));?></h3>
														...
														<table id="example1" class="table table-bordered table-striped">
																<thead>
																		...
																		<tr>
																				...
																				<th><?php echo  ucwords($this->lang->line('label_sendby'));?></th>
																				<th><?php echo  ucwords($this->lang->line('label_receiveby'));?></th>
																...
																<tbody>
																<?	
																if($this->data['passupreceive']){
																	$i=1;
																  for($j=0; $j< count($this->data['passupreceive']);$j++ ){

																  
																  	$rmemberdetail = $this->common_model->GetRow("MemberId ='".$this->data['passupreceive'][$j]."'","arm_members");
																	$dndetail=$this->common_model->GetRow("MemberId='".$rmemberdetail->DirectId."'",'arm_members');
																 	
																   ?>
																		<tr>
																				<td><?php echo  $i++;?></td>
																				<td><?php echo  $rmemberdetail->UserName;?></td>
																				<td><?php echo  $rmemberdetail->Email;?></td>
																				<td><?php echo  ucwords($dndetail->UserName);?></td>
																				<td><?php echo  ucwords($this->data['membername']);?></td>
																				<td><?php echo  date(' M-d-Y  - h:i:s ',strtotime($rmemberdetail->DateAdded));?></td>
												...
												<div class="box">
												<div class="box-header with-border">
														<h3 class="box-title"><?php echo  ucwords($this->lang->line('pagetitle_send'));?></h3>
														<div class="box-tools pull-right">
																<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
																<button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
														</div>
												...
												<div class="box-body">
														<table id="example2" class="table table-bordered table-striped">
																...
																<tbody>
																<?	if($this->data['passupsend']){
																	$i=1;
																  for($j=0; $j< count($this->data['passupsend']);$j++ ){

																  	
																  	$smemberdetail = $this->common_model->GetRow("MemberId ='".$this->data['passupsend'][$j]."'","arm_members");
																  
																   ?>
																		<tr>
																				<td><?php echo  $i++;?></td>
																				<td><?php echo  $smemberdetail->UserName;?></td>
																				<td><?php echo  $smemberdetail->Email;?></td>
																				<td><?php echo  ucwords($this->data['membername']);?></td>
																				<td><?php echo  ucwords($this->data['directname']);?></td>
																				<td><?php echo  date(' M-d-Y  - h:i:s ',strtotime($smemberdetail->DateAdded));?></td>
