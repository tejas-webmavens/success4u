														...
														<div class="row">
																<div class="prfle">
																		...
																		<div class="col-lg-12">
             															...
             															<h3>Biography URL<sup><em class="text-danger">*</em></sup></h3>
             															<a target="_blank" href="<?php echo base_url().'?ref='.$member->UserName;?>" ><?php echo base_url().'?ref='.$member->UserName;?></a>
             															</div>
																		...
																		<div class="col-md-7">
																		 ...
																		 <form method="post" action="" class="form" id="form-register" autocomplete="off">
																				<div class="dshfrom"><br>
																						...
																						<h3><?php echo  ucwords($this->lang->line('biocontent')); ?><sup><em class="text-danger">*</em></sup></h3>
															                            <textarea name="biocontent" class="ckeditor"  style="width:100%; height:200px;"><?php echo set_value('biocontent',isset($biography->BiographyContent)?$biography->BiographyContent : '');?></textarea>
															                            <h4><?php echo  form_error('biocontent');?></h4>
															                            <h3></h3>
																		...
																		<br><br><br><br>
																		<img src="<?php echo base_url();?>assets/user/img/bio.png" width= "100%" >
																		</div>
																</div>
														</div>
												</div>
