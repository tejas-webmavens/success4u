                                ...
                                <div class="card card-pricing card-raised">
                                    <div class="card-content">
                                        ...
                                        <h5 class="card-title text-primary">
                                            <span class="pull-left text-info">Your Balance:<b> ${{Auth::user()->profile->deposit_balance + 0}}</b></span>
                                        </h5><br>
                                        <h5 class="card-title text-primary">
                                            <span class="pull-left text-info">Invest Amount:<b> ${{$invest->amount}}</b></span>
                                        </h5><br>
                                        <h5 class="card-title text-primary">
                                            <span class="pull-left text-info">Net Profit:<b> ${{$invest->profit}}</b></span>
                                        </h5><br>
                                        <h5 class="card-title text-primary">
                                            <span class="pull-left text-info">Total Return:<b> ${{$invest->total}}</b></span>
                                        </h5>
                                        <br><br>
