                ...
                <div class="card card-content">
                    <div class="card-content">
                        <div class="alert alert-info">
                                <span> You have been select <b>{{$gateway->name}}</b>. Please note that <b>{{$gateway->name}}</b> will be charge you <b>${{$gateway->fixed}}</b> fixed + <b>{{$gateway->percent}}%</b> fee in every deposit.</span>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <h4><span class="text-primary">Current Balance: </span><span class="text-danger"><b>${{$user->profile->deposit_balance +0}}</b></span></h4>
                                <h4><span class="text-primary">Your  Amount: </span><span class="text-danger"><b>${{$deposit->amount +0}}</b></span></h4>
                                <h4><span class="text-primary">Gateway Charge: </span><span class="text-danger"><b>${{$deposit->charge + 0}}</b></span></h4>
                                <h4><span class="text-primary">Amount + Charge: </span><span class="text-danger"><b>${{($deposit-> net_amount + $deposit->charge) + 0}}</b></span></h4>
                            </div>
                            <div class="col-md-6">
                                <br><br>
                            ...
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                @if($gateway->details)
                                    ...
                                    <div class="text-center">
                                        ...
                                        {!! Markdown::convertToHtml($gateway->details) !!}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <h5 class="text-info">Step 2: Write This "<b>{{$deposit->code}}</b>" to Reference Option &amp; Send $60 to Our <b>{{$gateway->name}}</b> Account That Provided Above.</h5>
