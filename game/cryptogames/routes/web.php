...
Route::get('/CoinpaymentsIPN', 'CoinpaymentsController@validateIpn')->name('CoinpaymentsIPN');
/*
|--------------------------------------------------------------------------
...
Route::group(['middleware'=>'admin'], function (){
    ...
    Route::post('admin/website/settings/games/update/{id}', 'SettingsController@gamesSettings')->name('gamesSettings');
...
Route::group(['middleware'=>'auth'], function (){
    ...
    Route::get('user/viewads', 'UserAdvertsController@cashLinks')->name('userCash.links');
    Route::get('user/viewads/show/{id}', 'UserAdvertsController@cashLinkShow')->name('userCashLinks.show');
    Route::get('user/viewads/confirm/{id}', 'UserAdvertsController@cashLinkConfirm')->name('userCashLink.confirm');
    ...
    Route::post('user/deposit/btc', 'CoinpaymentsController@purchaseItems')->name('userDeposit.btc');

    Route::get('user/exchange', 'UserFundsTransferController@index')->name('userFundsTransfer');
    Route::post('user/exchange', 'UserFundsTransferController@self')->name('userFundsTransfer.self');
    Route::post('user/exchange/others', 'UserFundsTransferController@others')->name('userFundsTransfer.others');
    ...
    // Games Routes
    Route::get('user/games/rollgame', 'RollGameController@Home')->name('userRollGame');
    Route::post('user/games/rollgame', 'RollGameController@RollGame')->name('userRollGame.post');

    Route::get('user/faucet', 'FaucetController@Home')->name('userFaucet');
    Route::post('user/faucet', 'FaucetController@Faucet')->name('userFaucet.post');

    Route::get('user/games/cointail', 'CointailController@Home')->name('userCointail');
    Route::post('user/games/cointail', 'CointailController@Cointail')->name('userCointail.post');

    Route::get('user/games/slot', 'SlotGameController@Home')->name('userSlot');
    Route::post('user/games/slot/buy', 'SlotGameController@BuySlot')->name('userBuySlot');
    Route::post('user/games/slot', 'SlotGameController@Slot')->name('userSlot.post');
