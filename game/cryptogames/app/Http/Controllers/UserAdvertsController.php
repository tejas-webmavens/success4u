    ...
    public function cashLinks()
    {
        ...
        if ($ad == 0)
        {
            ...
            if ($ptcse == 0){
                ...
                session()->flash('upgrade_message', 'Sorry To Say You That Currently there is no Cash Links for you. Please wait or upgrade your membership, ');
                ...
                $adverts = Advert::whereUser_id($user->id)->where('date','=',date('Y-m-d'))->paginate(12);
