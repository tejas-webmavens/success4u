...
class UserMembershipsController extends Controller
{
    ...
    public function upgrade($id){
        ...
        if ($membership->price > $balance){
            ...
            session()->flash('upgrade_message', "You don't have sufficient balance. Please deposit money first or earn money");
        ...
        session()->flash('upgrade_message', 'You have Successfully Upgraded to '.$membership->name.' Membership Plan.');
