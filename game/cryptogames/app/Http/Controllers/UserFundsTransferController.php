...
class UserFundsTransferController extends Controller
{
    ...
    public function self(Request $request){
        ...
        if ($request->account == 1){
            ...
            if ($reamount > $balance){
                ...
                session()->flash('ex_message', "You don't have sufficient deposit balance. Please deposit money first.");
            ...
            session()->flash('ex_message', 'Your Balance Transfer Has Been Successfully Completed with '.$percentage.'% Transfer Fee.');
        ...
        elseif ($request->account == 2){
            ...
            if ($reamount > $balance){
                ...
                session()->flash('ex_message', "You don't have sufficient account balance. Please earn money first.");
                Session::flash('type', 'danger');
            ...
            if ($reamount > $balance){
                ...
                session()->flash('ex_message', "You don't have sufficient referral balance. Please earn money first.");
                Session::flash('type', 'danger');
    ...
    public function others(Request $request){
        ...
        if ($receiver_user == null){
            ...
            session()->flash('ex_message', "There is no user that have '".$request->email."' email address. Please check your email first.");
            Session::flash('type', 'danger');
        ...
        if ($type == 1){
            ...
            if ($reamount > $balance){
                ...
                session()->flash('ex_message', "You don't have sufficient balance in main account. Please earn money first.");
                Session::flash('type', 'danger');
          ...
          $user->notify(new SendMoneySuccess($data));
            ...
            session()->flash('ex_message', 'After Charging Transfer Fee Your Total Sending Amount $ '.$new_amount.' Has Been Successfully Send.');
            Session::flash('type', 'success');
        ...
        elseif ($type == 2){
            ...
            if ($reamount > $balance){
                ...
                session()->flash('ex_message', "You don't have sufficient balance in deposit account. Please deposit money first.");
                Session::flash('type', 'danger');
